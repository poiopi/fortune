...
// calcKyusei() / calcMonthStar() / getKyuseiData() は inc/kyusei-core.php へ移設
// （ロジックは完全に同一、DayInfoServiceから安全に再利用するための切り出し）。
require_once __DIR__.'/inc/kyusei-core.php';
...
select.form-input{appearance:none;-webkit-appearance:none;background-color:#1a1530;color:#e8e0f8;cursor:pointer;color-scheme:dark}
