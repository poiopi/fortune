...
<div class="wrap">
  ...
  <div class="tool-desc">
    <p>MBTI（16タイプ診断）は、ユングの心理学をベースに、人の認識や判断の傾向を16の性格タイプに分類する自己理解ツールです。</p>
    <p>この簡易セルフ診断では、いくつかの質問に答えることであなたの強みや意思決定の傾向、向いている環境を算出します。自分への理解を深め、より良い人間関係を築くためのヒントとしてご利用ください。</p>
  </div>
