...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/tarot/lovers/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="タロット「恋人（THE LOVERS）」の意味を徹底解説。正位置・逆位置それぞれの恋愛・仕事・人間関係への影響と、カードが伝えるメッセージをわかりやすく紹介します。">
  <title>恋人（THE LOVERS）タロットの意味｜正位置・逆位置・恋愛・仕事を解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}:root{--ff-serif:'Shippori Mincho',serif;--ff-sans:'Zen Kaku Gothic New',sans-serif;--ff-mono:'DM Mono',monospace;--accent:#7c4dce;--accent-lt:#9b72ef;--gold:#c9a84c;--text:#1a1a2e;--muted:#6b6b8a;--border:#e5e3ee;--bg:#faf7ff;--bg2:#f8f7fc;}
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"恋人カードは好きな人の気持ちを示しますか？","acceptedAnswer":{"@type":"Answer","text":"相手の心が動いているサインです。ただし「選択」のカードでもあるため、どちらかが決断を迫られている状況の可能性もあります。"}},{"@type":"Question","name":"恋人の逆位置は別れを意味しますか？","acceptedAnswer":{"@type":"Answer","text":"必ずしも別れではありません。関係の見直しや価値観の調整が必要なサインです。今の関係の本質を問い直す時期を示しています。"}},{"@type":"Question","name":"恋人は仕事でどんな意味？","acceptedAnswer":{"@type":"Answer","text":"重要な選択や提携・協力関係が鍵になる時期です。どちらかの選択肢を選ぶ必要がある場面で、心の声を優先することが大切です。"}}]}</script>
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"占いPortal","item":"https://life-fun.net/"},{"@type":"ListItem","position":2,"name":"タロット占い","item":"https://life-fun.net/tarot"},{"@type":"ListItem","position":3,"name":"タロット解説","item":"https://life-fun.net/articles/tarot/"},{"@type":"ListItem","position":4,"name":"恋人（THE LOVERS）","item":"https://life-fun.net/articles/tarot/lovers/"}]}</script>
</head>
<body>
...
<div class="wrap">
  <nav class="breadcrumb"><a href="/">占いPortal</a><span>›</span><a href="/articles/tarot/">タロット解説</a><span>›</span>恋人（THE LOVERS）</nav>
  <div class="art-hero">
  ...
  <section class="art-section">
    ...
    $ctaText  = '今のあなたには恋人ではなく、別のカードが現れるかもしれません。';
    $ctaUrl   = '/tarot';
    $ctaBtn   = 'タロット占いを始める →';
  ...
  <section class="art-section">
    ...
    <?php
    $prevTitle = '法王';
    $prevUrl   = '/articles/tarot/hierophant/';
    $prevLabel = '← 前のカード';
    $nextTitle = '戦車';
    $nextUrl   = '/articles/tarot/chariot/';
    $nextLabel = '次のカード →';
    $listTitle = '大アルカナ一覧';
