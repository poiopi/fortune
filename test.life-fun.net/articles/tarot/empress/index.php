...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/tarot/empress/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="タロット「女帝（THE EMPRESS）」の意味を徹底解説。正位置・逆位置それぞれの恋愛・仕事・人間関係への影響と、カードが伝えるメッセージをわかりやすく紹介します。">
  <title>女帝（THE EMPRESS）タロットの意味｜正位置・逆位置・恋愛・仕事を解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .card-en{font-family:var(--ff-mono);font-size:.5rem;letter-spacing:.18em;color:rgba(201,168,76,.75);text-transform:uppercase;margin-bottom:.25rem;}.card-ja{font-family:var(--ff-serif);font-size:.85rem;font-weight:700;color:#e8e0ff}
...
<div class="wrap">
  ...
  <div class="art-hero">
    <div class="art-hero-text">
      ...
      <h1>女帝（THE EMPRESS）<br>タロットの意味・正位置・逆位置</h1>
      <p class="art-lead">大アルカナ3番「女帝」は、大地の豊かさと母性を体現するカードです。何かを生み出し、育て、実らせる創造の女神。愛情と豊かさのエネルギーが満ちあふれる時、このカードが現れます。</p>
      <div class="kw-tags"><span class="kw-tag upright">豊かさ</span><span class="kw-tag upright">母性</span><span class="kw-tag upright">創造</span><span class="kw-tag upright">育む</span><span class="kw-tag upright">感覚の喜び</span> <span class="kw-tag reversed">依存</span><span class="kw-tag reversed">過保護</span><span class="kw-tag reversed">創造性の枯渇</span></div>
    </div>
  ...
  <section class="art-section"><h2>他のカードを見る</h2><div class="card-nav"><a href="/articles/tarot/high-priestess/" class="card-nav-item"><div class="card-nav-dir">← 前のカード</div><div class="card-nav-name">女教皇</div></a><a href="/articles/tarot/emperor/" class="card-nav-item"><div class="card-nav-dir">次のカード →</div><div class="card-nav-name">皇帝</div></a></div></section>
