...
<div class="wrap">
  ...
  </div><div class="cat-card"><div class="cat-label">REVERSED · 逆位置</div><div class="cat-text">相手への過度な依存、または支配的になりすぎていないかを確認してください。愛情が重さになっていないか、立ち止まって見直す時です。</div></div></div></section>
  ...
  <section class="art-section">
    ...
    $ctaText  = '今のあなたには女帝ではなく、別のカードが現れるかもしれません。';
    $ctaUrl   = '/tarot';
    $ctaBtn   = 'タロット占いを始める →';
  ...
  <section class="art-section">
    ...
    <?php
    $prevTitle = '女教皇';
    $prevUrl   = '/articles/tarot/high-priestess/';
    $prevLabel = '← 前のカード';
    $nextTitle = '皇帝';
    $nextUrl   = '/articles/tarot/emperor/';
    $nextLabel = '次のカード →';
    $listTitle = '大アルカナ一覧';
