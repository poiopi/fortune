...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/tarot/chariot/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="タロット「戦車（THE CHARIOT）」の意味を徹底解説。正位置・逆位置それぞれの恋愛・仕事・人間関係への影響と、カードが伝えるメッセージをわかりやすく紹介します。">
  <title>戦車（THE CHARIOT）タロットの意味｜正位置・逆位置・恋愛・仕事を解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}:root{--ff-serif:'Shippori Mincho',serif;--ff-sans:'Zen Kaku Gothic New',sans-serif;--ff-mono:'DM Mono',monospace;--accent:#7c4dce;--accent-lt:#9b72ef;--gold:#c9a84c;--text:#1a1a2e;--muted:#6b6b8a;--border:#e5e3ee;--bg:#faf7ff;--bg2:#f8f7fc;}
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"戦車は恋愛で良いカード？","acceptedAnswer":{"@type":"Answer","text":"正位置は積極的なアプローチが実ります。障害があっても突破できるサインです。自分から動くことが吉です。"}},{"@type":"Question","name":"戦車の逆位置は何を示す？","acceptedAnswer":{"@type":"Answer","text":"感情的な暴走・力任せ・方向性の喪失への警告です。力があっても、制御がなければただの破壊になります。"}},{"@type":"Question","name":"戦車が仕事で出たら？","acceptedAnswer":{"@type":"Answer","text":"競争に勝てる時期です。集中と自制心が武器になります。今は迷わず前進することが正解です。"}}]}</script>
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"占いPortal","item":"https://life-fun.net/"},{"@type":"ListItem","position":2,"name":"タロット占い","item":"https://life-fun.net/tarot"},{"@type":"ListItem","position":3,"name":"タロット解説","item":"https://life-fun.net/articles/tarot/"},{"@type":"ListItem","position":4,"name":"戦車（THE CHARIOT）","item":"https://life-fun.net/articles/tarot/chariot/"}]}</script>
</head>
<body>
...
<div class="wrap">
  ...
  <section class="art-section">
    ...
    $ctaText  = '今のあなたには戦車ではなく、別のカードが現れるかもしれません。';
    $ctaUrl   = '/tarot';
    $ctaBtn   = 'タロット占いを始める →';
  ...
  <section class="art-section">
    ...
    <?php
    $prevTitle = '恋人';
    $prevUrl   = '/articles/tarot/lovers/';
    $prevLabel = '← 前のカード';
    $nextTitle = '力';
    $nextUrl   = '/articles/tarot/strength/';
    $nextLabel = '次のカード →';
    $listTitle = '大アルカナ一覧';
