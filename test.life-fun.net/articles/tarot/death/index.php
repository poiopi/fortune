...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/tarot/death/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="タロット「死神（DEATH）」の意味を徹底解説。正位置・逆位置それぞれの恋愛・仕事・人間関係への影響と、カードが伝えるメッセージをわかりやすく紹介します。">
  <title>死神（DEATH）タロットの意味｜正位置・逆位置・恋愛・仕事を解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}:root{--ff-serif:'Shippori Mincho',serif;--ff-sans:'Zen Kaku Gothic New',sans-serif;--ff-mono:'DM Mono',monospace;--accent:#7c4dce;--accent-lt:#9b72ef;--gold:#c9a84c;--text:#1a1a2e;--muted:#6b6b8a;--border:#e5e3ee;--bg:#faf7ff;--bg2:#f8f7fc;}
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"死神のカードは本当に死を意味しますか？","acceptedAnswer":{"@type":"Answer","text":"タロットの死神が文字通りの死を意味することはほとんどありません。変容・終わりと始まりの象徴として扱われます。怖がらないでください。"}},{"@type":"Question","name":"死神が恋愛で出たら？","acceptedAnswer":{"@type":"Answer","text":"正位置は関係の大きな変化（別れか再生か）を示します。逆位置は終わった関係への執着を表します。どちらも「変化の時」のサインです。"}},{"@type":"Question","name":"死神の逆位置は怖い？","acceptedAnswer":{"@type":"Answer","text":"怖くはありません。変化を拒む自分への気づきを促しているカードです。抵抗が強いほど、変化が必要なサインとも言えます。"}}]}</script>
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"占いPortal","item":"https://life-fun.net/"},{"@type":"ListItem","position":2,"name":"タロット占い","item":"https://life-fun.net/tarot"},{"@type":"ListItem","position":3,"name":"タロット解説","item":"https://life-fun.net/articles/tarot/"},{"@type":"ListItem","position":4,"name":"死神（DEATH）","item":"https://life-fun.net/articles/tarot/death/"}]}</script>
</head>
<body>
...
<div class="wrap">
  ...
  <section class="art-section">
    ...
    $ctaText  = '今のあなたには死神ではなく、別のカードが現れるかもしれません。';
    $ctaUrl   = '/tarot';
    $ctaBtn   = 'タロット占いを始める →';
  ...
  <section class="art-section">
    ...
    <?php
    $prevTitle = '吊られた男';
    $prevUrl   = '/articles/tarot/hanged-man/';
    $prevLabel = '← 前のカード';
    $nextTitle = '節制';
    $nextUrl   = '/articles/tarot/temperance/';
    $nextLabel = '次のカード →';
    $listTitle = '大アルカナ一覧';
