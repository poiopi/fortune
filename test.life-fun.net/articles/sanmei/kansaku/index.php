...
<head>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"貫索星とはどんな星ですか？","acceptedAnswer":{"@type":"Answer","text":"算命学の貫索星は、自我の本能を司り、強い自立心を象徴する十大主星の一つです。五行では「木性の陽」に属し、折れない強い意志を表します。集団に染まらない独自の存在感を持ちます。"}},
...
<div class="wrap">
  ...
  <section class="art-section" id="about">
    <h2>貫索星とは</h2>
    <p>算命学の人体図は、星の配置から個人の精神や才能を読み解くための図です。その中で自我の本能を司る貫索星は、自分という存在を確立する働きを持つ星です。現れる位置によって意味合いは変化しますが、基本的には自立心の土台となる星といえます。誰かに依存するのではなく、自分の力で立って進むことを自然と選ぶ傾向があります。</p>
    <div class="star-info">
      <span class="star-info-item"><strong>五行</strong>　木性（陽）</span>
      <span class="star-info-item"><strong>象徴</strong>　大樹・信念・自立</span>
  ...
  <section class="art-section" id="love">
    <h2>恋愛運</h2>
    <p>この星を持つ人の恋愛は、一歩ずつ慎重に関係を育んでいくじっくり型です。一目惚れや一時的な盛り上がりで交際を始めることは少なく、相手が信頼できる人物か見極める時間を大切にします。惹かれやすいのは、お互いの価値観を認め合える自立したパートナーです。過度な依存を望まず、仕事や個人の趣味に打ち込める適度な距離感を心地よく感じます。</p>
    <p>交際が始まると、相手に対して誠実に向き合い、一途な愛を注ぐ傾向があります。ただし、恋人同士であっても一人の時間や個人のスペースを必要とするのがこの星の特徴です。べったりとした付き合いは息苦しさを感じやすいため、お互いが対等な関係を維持することが長続きの秘訣といえます。結婚に関しても、古風で安定した家庭を選びやすい傾向がありますが、自分の軸を持つ人間同士のパートナーシップを大切にします。</p>
  </section>
  ...
  <section class="art-section" id="work">
    ...
    <p>一方で、急な方針変更が多い職場や、チームプレイ必須のアシスタント業務は苦手な傾向です。指示が頻繁に変わる環境では自分のペースが乱され、強いストレスを感じやすくなります。一つの分野をコツコツと掘り下げていく専門家としての働き方が、この星の強みを最も活かせるスタイルです。焦らずに独自のスキルを磨き続けることで、年齢を重ねるごとに確かな評価と独自の地位を築けます。</p>
  </section>
  ...
  <section class="art-section" id="message">
    ...
    <p>宿命にこの星を宿すあなたが持つ、自分を信じて進む力は素晴らしい才能です。周囲の流行や他人の言葉に惑わされず、自らの信念を大切に守り抜く姿は、周囲に安心感を与えています。その一貫した姿勢は、自然と信頼を集める力にもなります。</p>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        ...
        <div class="faq-a">算命学の貫索星は、自我の本能を司り、強い独立心を象徴する十大主星の一つです。五行では「木性の陽」に属し、折れない強い意志を表します。他人に依存せず自分の力で立つことを自然と選ぶため、集団に染まらない独自の存在感を持ちます。</div>
      </div>
      <div class="faq-item">
  ...
  <section class="art-section" id="matome">
    ...
    <ul class="matome-list">
      <li>貫索星は算命学十大主星の一つ。五行「木性の陽」に属し、自立・信念・孤高がキーワード。</li>
      <li>自分の軸を持ち、他人の意見に流されない強い独立心と信念の持ち主。</li>
      <li>恋愛では深い信頼関係を築くまでに時間がかかるが、一度縁を結ぶと非常に誠実。</li>
      <li>研究・職人・独立経営など、自分のペースで深めていける仕事が向いている。</li>
      <li>孤独を恐れず信念を貫く一方、信頼できる人に弱みを見せる勇気が開運につながる。</li>
    </ul>
  </section>
