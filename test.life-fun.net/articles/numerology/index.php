...
<head>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  @media(max-width:600px){.art-footer-inner{grid-template-columns:1fr;gap:1.5rem}.cta-box{flex-direction:column;align-items:flex-start}.num-grid{grid-template-columns:repeat(auto-fill,minmax(120px,1fr))}}
  </style>
...
<div class="wrap">
  ...
  <div class="cta-box">
    ...
    <a href="/numerology" class="cta-btn">数秘術を診断する →</a>
  </div>
  ...
  <section class="art-section" id="related">
    ...
    <div class="related-grid">
      ...
      <a href="/articles/seimei/" class="related-card">
        <div class="related-card-label">姓名判断とは</div>
        <div class="related-card-title">名前の画数から運勢を読む →</div>
      </a>
      ...
      <a href="/articles/kyusei/" class="related-card">
        ...
        <div class="related-card-title">今年の運気の流れを九星で知る →</div>
      </a>
    </div>
  </section>
