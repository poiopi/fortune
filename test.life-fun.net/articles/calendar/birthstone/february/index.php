...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/birthstone/february/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="2月の誕生石アメジストの石言葉・特徴・魅力をわかりやすく解説。「誠実、心の平和」を象徴する宝石の意味とおすすめの身につけ方を紹介します。">
  <title>2月の誕生石はアメジスト｜石言葉と魅力をわかりやすく解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"アメジストはなぜ紫色をしているのですか？","acceptedAnswer":{"@type":"Answer","text":"水晶（石英）に微量の鉄分が含まれ、自然界の放射線の影響を受けることで紫色に発色するとされています。"}},
      {"@type":"Question","name":"アメジストの石言葉の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"「誠実、心の平和」という石言葉は、心を落ち着かせ冷静さをもたらすとされる石の性質に由来すると考えられています。"}},
      {"@type":"Question","name":"アメジスト以外に2月の誕生石はありますか？","acceptedAnswer":{"@type":"Answer","text":"地域や機関によって多少の違いがありますが、日本の誕生石ではアメジストが2月の石として広く知られています。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":5,"name":"2月の誕生石（アメジスト）とは","item":"https://life-fun.net/articles/calendar/birthstone/february/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthstone/">誕生石とは</a><span>›</span>2月の誕生石（アメジスト）とは
  </nav>

  <div class="art-hero">
    <span class="art-label">FEBRUARY · 誕生石</span>
    <h1>2月の誕生石はアメジスト<br>石言葉と魅力をわかりやすく解説</h1>
    <p class="art-lead">アメジストは、紫色の美しい輝きを持つ2月の誕生石です。石言葉は「誠実、心の平和」。心を落ち着かせ、冷静な判断力をもたらす石として、古くから愛されてきました。</p>
  </div>

  <dl class="basic-info">
    <dt>石名</dt><dd>アメジスト</dd>
    <dt>英語名</dt><dd>Amethyst</dd>
    <dt>石言葉</dt><dd>誠実、心の平和</dd>
    <dt>色</dt><dd>紫色</dd>
  </dl>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">アメジストとは</a></li>
      <li><a href="#meaning">アメジストが象徴する意味</a></li>
      <li><a href="#charm">アメジストの魅力・こんな人におすすめ</a></li>
      <li><a href="#care">お手入れについて</a></li>
      <li><a href="#today">2月が誕生月の人へ</a></li>
  ...
  <section class="art-section" id="about">
    <h2>アメジストとは</h2>
    <p>アメジストは、紫色の美しい輝きを持つ石英（水晶）の一種で、2月の誕生石として知られています。名前はギリシャ語で「酔わない」を意味する言葉に由来し、古代には酒に酔うのを防ぐお守りとして身につけられていたと伝えられています。淡い紫からロイヤルパープルまで幅広い色合いがあり、その気品ある色から古くから宝飾品として珍重されてきました。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>アメジストが象徴する意味</h2>
    <p>アメジストの石言葉は「誠実、心の平和」です。心を落ち着かせ、冷静な判断力をもたらす石として親しまれ、高ぶった感情を鎮めるお守りとしても知られています。古代ヨーロッパでは司教や聖職者の指輪にも使われ、高貴さと精神性を象徴する石とされてきました。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>アメジストの魅力・こんな人におすすめ</h2>
    <p>アメジストの魅力は、紫という色そのものが持つ気品と神秘性にあります。派手すぎず、それでいて存在感のある色合いは、日常使いから特別な場面まで幅広く似合います。気持ちを落ち着けたいとき、誠実な関係を築きたいとき、心穏やかに過ごしたい日のお守りとして選ばれています。2月生まれの方だけでなく、精神的な安定を求める人への贈り物にも向いています。</p>
  </section>

  <section class="art-section" id="care">
    <h2>お手入れについて</h2>
    <p>アメジストは紫外線に長時間さらされると色が薄くなることがあるため、直射日光を避けて保管すると美しさを保ちやすくなります。</p>
  </section>

  <section class="art-section" id="today">
    <h2>2月が誕生月の人へ</h2>
    <p>2月生まれの方はもちろん、心の平和を大切にしたい方への贈り物としてもアメジストは人気の石です。開運カレンダーでは、誕生石だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">アメジストはなぜ紫色をしているのですか？</div>
        <div class="faq-a">水晶（石英）に微量の鉄分が含まれ、自然界の放射線の影響を受けることで紫色に発色するとされています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">アメジストの石言葉の由来は何ですか？</div>
        <div class="faq-a">「誠実、心の平和」という石言葉は、心を落ち着かせ冷静さをもたらすとされる石の性質に由来すると考えられています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">アメジスト以外に2月の誕生石はありますか？</div>
        <div class="faq-a">地域や機関によって多少の違いがありますが、日本の誕生石ではアメジストが2月の石として広く知られています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>アメジストは紫色が美しい、2月の誕生石</li>
      <li>石言葉は「誠実、心の平和」、心を落ち着かせる石とされる</li>
      <li>気品ある色合いが魅力で、精神的な安定を願う人への贈り物にも人気</li>
      <li>紫外線による色あせを避け、直射日光を避けて保管したい</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthstone/january/';
  $prevTitle = '1月の誕生石（ガーネット）とは';
  $nextUrl   = '/articles/calendar/birthstone/march/';
  $nextTitle = '3月の誕生石（アクアマリン）とは';
...
<?php $currentSlug='calendar-birthstone-february'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthstone-february');
?>
