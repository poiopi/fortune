...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/gogyo/kin/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="五行「金（こん）」の意味・性質・ラッキーカラー・相性を解説。清潔と収穫のエネルギーを持つ金のエネルギーを日常に取り入れる方法を紹介します。">
  <title>五行「金（こん）」とは？意味とラッキーカラーをわかりやすく解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"金の五行に合う色は何ですか？","acceptedAnswer":{"@type":"Answer","text":"白・ゴールド・シルバーが金のエネルギーに対応する色です。金運や決断力を高めたいとき、財布やアクセサリーにこれらの色を取り入れるのがおすすめです。"}},
      {"@type":"Question","name":"金の五行の人はどんな性格ですか？","acceptedAnswer":{"@type":"Answer","text":"金の気が強い人は、意志が強く決断力があり、完璧主義な傾向があるとされます。合理的で正義感が強い一方、融通が利きにくい面もあるといわれます。"}},
      {"@type":"Question","name":"金は何に剋されますか？","acceptedAnswer":{"@type":"Answer","text":"五行の相剋関係では「火は金を剋す」とされます。火の気が強すぎると金のエネルギーが弱まる（金属が溶ける）という考え方です。逆に金は木を剋す（金属の刃物は木を切る）関係にあります。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":5,"name":"金とは","item":"https://life-fun.net/articles/calendar/gogyo/kin/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/gogyo/">陰陽五行とは</a><span>›</span>金とは
  </nav>

  <div class="art-hero">
    <span class="art-label">KIN · 五行</span>
    <h1>五行「金（こん）」とは？<br>意味とラッキーカラーをわかりやすく解説</h1>
    <p class="art-lead">金（こん）は陰陽五行の一つで、清潔・収穫・決断を象徴するエネルギーです。鉱物や金属のように、磨かれて価値を持つ完成のパワーを表します。意味・ラッキーカラー・相性まで詳しく解説します。</p>
  </div>

  <dl class="basic-info">
    <dt>読み方</dt><dd>こん</dd>
    <dt>象徴するエネルギー</dt><dd>清潔・収穫・決断</dd>
    <dt>ラッキーカラー</dt><dd>白・ゴールド・シルバー</dd>
    <dt>季節</dt><dd>秋</dd>
  </dl>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">金の意味</a></li>
      <li><a href="#color">金のラッキーカラー</a></li>
      <li><a href="#personality">金の気を持つ人の性格</a></li>
  ...
  <section class="art-section" id="about">
    <h2>金の意味</h2>
    <p>金（こん）は陰陽五行の中で、鉱物や金属が磨かれて価値を持つ様子を象徴する要素です。清潔・収穫・決断・完成を表し、五行の循環の中では実りの季節である秋に対応します。物事を引き締め、形にするエネルギーとして知られています。</p>
    <p>相生の関係では、金は水を生み出す存在です（金属の表面に水滴が生じる、鉱脈から水が湧く）。一方、相剋の関係では、金は木を切り（金剋木）、火によって溶かされる（火剋金）という関係にあります。</p>
  </section>

  <section class="art-section" id="color">
    <h2>金のラッキーカラー</h2>
    <p>金の気に対応する色は白・ゴールド・シルバーです。清潔感・完成・豊かさを象徴する色で、金運や決断力を高めたいときに効果的とされています。財布を白やゴールド系にする・シルバーのアクセサリーを身につける・白い小物をデスクに置くといった活用法があります。</p>
    <p>物事にけじめをつけたいとき・大きな決断をするときは、金のラッキーカラーである白・ゴールド系の色を意識的に取り入れると良いとされています。</p>
  </section>

  <section class="art-section" id="personality">
    <h2>金の気を持つ人の性格</h2>
    <p>四柱推命や九星気学において「金」の気が強い人は、意志が強く決断力があり、完璧主義な傾向があるとされています。合理的で正義感が強く、筋を通すことを大切にするタイプです。</p>
    <p>一方で、融通が利きにくい・完璧主義ゆえに自分にも他人にも厳しくなりすぎる面もあるといわれます。金の気が強い人は、時には柔軟さを意識することで、持ち前の決断力をより効果的に活かせるとされています。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">金の五行に合う色は何ですか？</div>
        <div class="faq-a">白・ゴールド・シルバーが金のエネルギーに対応する色です。金運や決断力を高めたいとき、財布やアクセサリーにこれらの色を取り入れるのがおすすめです。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">金の五行の人はどんな性格ですか？</div>
        <div class="faq-a">金の気が強い人は、意志が強く決断力があり、完璧主義な傾向があるとされます。合理的で正義感が強い一方、融通が利きにくい面もあるといわれます。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">金は何に剋されますか？</div>
        <div class="faq-a">五行の相剋関係では「火は金を剋す」とされます。火の気が強すぎると金のエネルギーが弱まる（金属が溶ける）という考え方です。逆に金は木を剋す（金属の刃物は木を切る）関係にあります。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>金は清潔・収穫・決断を象徴する五行の一つで、実りの季節「秋」に対応する。</li>
      <li>ラッキーカラーは白・ゴールド・シルバー。金運や決断力を後押ししてくれるとされる。</li>
      <li>金の気が強い人は決断力があり完璧主義だが、融通が利きにくい面もある。</li>
      <li>相生では水を生み、相剋では木を剋し、火に剋される関係にある。</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/gogyo/tsuchi/';
  $prevTitle = '土';
  $nextUrl   = '/articles/calendar/gogyo/mizu/';
  $nextTitle = '水';
...
<?php $currentSlug='gogyo-kin'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'gogyo-kin');
?>
