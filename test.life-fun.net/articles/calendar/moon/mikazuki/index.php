...
<head>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"三日月はいつからいつまでの月ですか？","acceptedAnswer":{"@type":"Answer","text":"厳密には新月から3日目の月を指す言葉ですが、一般的には新月から上弦の月までの、光が少しずつ増えていく期間の月相を指して使われることが多いです。"}},
      {"@type":"Question","name":"三日月の形はなぜ細い弓形なのですか？","acceptedAnswer":{"@type":"Answer","text":"太陽・地球・月の位置関係によって、月に当たる太陽光のうち地球から見える部分がまだ少ないためです。日が経つにつれて光の当たる面積が増え、満月に近づいていきます。"}},
      {"@type":"Question","name":"三日月に何をすると良いですか？","acceptedAnswer":{"@type":"Answer","text":"新月で立てた目標に向けて、情報収集や準備、小さな行動を始めるのに向いているとされています。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":5,"name":"三日月とは","item":"https://life-fun.net/articles/calendar/moon/mikazuki/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/moon/">月の満ち欠けとは</a><span>›</span>三日月とは
  </nav>

  <div class="art-hero">
    <span class="art-label">MIKAZUKI · 月相</span>
    <h1>三日月とは？<br>意味と過ごし方をわかりやすく解説</h1>
    <p class="art-lead">三日月（みかづき）は、新月を過ぎて数日、細い光の弧が姿を見せ始める時期の月です。新月から満月へ向けて少しずつ満ちていく、成長と芽生えを象徴する月相です。</p>
  </div>

  <dl class="basic-info">
    <dt>読み方</dt><dd>みかづき</dd>
    <dt>英語名</dt><dd>Waxing Crescent</dd>
    <dt>月齢</dt><dd>1.8〜5.5</dd>
    <dt>見え方</dt><dd>細い弓形の光が西の空に見え始める</dd>
  </dl>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">三日月とは</a></li>
      <li><a href="#spiritual">三日月が持つスピリチュアルな意味</a></li>
      <li><a href="#action">三日月におすすめの過ごし方</a></li>
      <li><a href="#avoid">三日月に避けたいこと</a></li>
      <li><a href="#today">今日が三日月の日なら</a></li>
  ...
  <section class="art-section" id="about">
    <h2>三日月とは</h2>
    <p>三日月は新月を過ぎて数日、細い光の弧が姿を見せ始める時期の月です。名前の通り「三日目の月」を指しますが、暦の上ではおおよそ月齢2〜5日頃までの、まだ光の面積が小さい成長初期の月相全体を指して使われます。</p>
  </section>

  <section class="art-section" id="spiritual">
    <h2>三日月が持つスピリチュアルな意味</h2>
    <p>新月で立てた願いや目標が、少しずつ形になり始める段階とされています。まだ小さな光ですが、これから満ちていくエネルギーを内に秘めた時期として、成長や芽生えの象徴とされています。</p>
  </section>

  <section class="art-section" id="action">
    <h2>三日月におすすめの過ごし方</h2>
    <p>新月で決めた目標に向けて、具体的な小さな行動を積み重ねるのに向いています。情報収集や準備、人に相談することなど、次の一歩につながる動きを始めるのに良いタイミングです。</p>
  </section>

  <section class="art-section" id="avoid">
    <h2>三日月に避けたいこと</h2>
    <p>まだエネルギーが十分に満ちていない時期なので、大きな成果を焦って求めすぎないようにしましょう。結果を急ぐと息切れしてしまうことがあります。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が三日月の日なら</h2>
    <p>小さな一歩を積み重ねる日として、今日できることを一つだけ決めて取り組んでみてください。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">三日月はいつからいつまでの月ですか？</div>
        <div class="faq-a">厳密には新月から3日目の月を指す言葉ですが、一般的には新月から上弦の月までの、光が少しずつ増えていく期間の月相を指して使われることが多いです。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">三日月の形はなぜ細い弓形なのですか？</div>
        <div class="faq-a">太陽・地球・月の位置関係によって、月に当たる太陽光のうち地球から見える部分がまだ少ないためです。日が経つにつれて光の当たる面積が増え、満月に近づいていきます。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">三日月に何をすると良いですか？</div>
        <div class="faq-a">新月で立てた目標に向けて、情報収集や準備、小さな行動を始めるのに向いているとされています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>三日月は新月から数日、光が少しずつ増え始める成長初期の月</li>
      <li>「芽生え」「成長」を象徴し、新月の願いを行動に移す時期</li>
      <li>小さな一歩を積み重ねる過ごし方がおすすめ</li>
      <li>大きな成果を焦って求めすぎないよう注意</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/moon/shingetsu/';
  $prevTitle = '新月';
  $nextUrl   = '/articles/calendar/moon/jougen/';
  $nextTitle = '上弦の月';
  ...
  <section class="art-section" id="related">
    ...
    <?php
    $relatedItems = [
      ['label'=>'十六夜月とは', 'title'=>'対になる月相を知る →', 'url'=>'/articles/calendar/moon/izayoi/'],
      ['label'=>'上弦の月とは', 'title'=>'次の月相を知る →', 'url'=>'/articles/calendar/moon/jougen/'],
...
<?php $currentSlug='mikazuki'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'mikazuki');
?>
