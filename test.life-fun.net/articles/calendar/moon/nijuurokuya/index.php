...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/moon/nijuurokuya/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="二十六夜月の意味・スピリチュアルな解釈・おすすめの過ごし方を解説。次の新月に向けて静けさを象徴する月相にすべきことを紹介します。">
  <title>二十六夜月とは？意味と過ごし方をわかりやすく解説｜月相ガイド</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"二十六夜月の次はどうなりますか？","acceptedAnswer":{"@type":"Answer","text":"二十六夜月を過ぎると、月はさらに光を減らして新月を迎え、そこから再び満ちていく新しいサイクルが始まります。"}},
      {"@type":"Question","name":"二十六夜月はどの時間帯に見えますか？","acceptedAnswer":{"@type":"Answer","text":"二十六夜月は明け方近くに昇り、日の出前の東の空にわずかに見えます。日中は見えないことが多い月相です。"}},
      {"@type":"Question","name":"二十六夜月の日に向いていることは？","acceptedAnswer":{"@type":"Answer","text":"休息や振り返り、心を落ち着けて過ごすことが向いているとされています。次の新月に向けてエネルギーを蓄える時期です。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":5,"name":"二十六夜月とは","item":"https://life-fun.net/articles/calendar/moon/nijuurokuya/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/moon/">月の満ち欠けとは</a><span>›</span>二十六夜月とは
  </nav>

  <div class="art-hero">
    <span class="art-label">NIJUUROKUYA · 月相</span>
    <h1>二十六夜月とは？<br>意味と過ごし方をわかりやすく解説</h1>
    <p class="art-lead">二十六夜月（にじゅうろくやづき）は、新月の直前、光がごく細くなった月相です。次の新月に向けて静かに光を減らしていく、静けさと内省を象徴する月です。</p>
  </div>

  <dl class="basic-info">
    <dt>読み方</dt><dd>にじゅうろくやづき</dd>
    <dt>英語名</dt><dd>Waning Crescent Moon</dd>
    <dt>月齢</dt><dd>24.0〜27.7</dd>
    <dt>見え方</dt><dd>光が細くなり、明け方の空にわずかに見える</dd>
  </dl>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">二十六夜月とは</a></li>
      <li><a href="#spiritual">二十六夜月が持つスピリチュアルな意味</a></li>
      <li><a href="#action">二十六夜月におすすめの過ごし方</a></li>
      <li><a href="#avoid">二十六夜月に避けたいこと</a></li>
      <li><a href="#today">今日が二十六夜月の日なら</a></li>
  ...
  <section class="art-section" id="about">
    <h2>二十六夜月とは</h2>
    <p>二十六夜月は新月の直前、光がごく細くなった月相です。夜明け前の東の空にわずかに姿を見せ、次の新月に向けて静かに光を減らしていく時期にあたります。</p>
  </section>

  <section class="art-section" id="spiritual">
    <h2>二十六夜月が持つスピリチュアルな意味</h2>
    <p>一朔望月の締めくくりにあたるこの時期は、静けさと内省の象徴とされています。次の新月で新しいサイクルを迎える前の、心身を休める準備期間として大切にされてきました。</p>
  </section>

  <section class="art-section" id="action">
    <h2>二十六夜月におすすめの過ごし方</h2>
    <p>ゆっくり休息をとる、これまでの一巡りを振り返る、心を落ち着けて過ごすといったことがおすすめです。無理に活動的に過ごすより、静かな時間を大切にしましょう。</p>
  </section>

  <section class="art-section" id="avoid">
    <h2>二十六夜月に避けたいこと</h2>
    <p>エネルギーが最も少なくなる時期のため、大きな決断や新しい挑戦は避け、次の新月まで力を蓄えることを優先しましょう。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が二十六夜月の日なら</h2>
    <p>一呼吸置いて、これまでを振り返る静かな時間を作ってみてください。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">二十六夜月の次はどうなりますか？</div>
        <div class="faq-a">二十六夜月を過ぎると、月はさらに光を減らして新月を迎え、そこから再び満ちていく新しいサイクルが始まります。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">二十六夜月はどの時間帯に見えますか？</div>
        <div class="faq-a">二十六夜月は明け方近くに昇り、日の出前の東の空にわずかに見えます。日中は見えないことが多い月相です。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">二十六夜月の日に向いていることは？</div>
        <div class="faq-a">休息や振り返り、心を落ち着けて過ごすことが向いているとされています。次の新月に向けてエネルギーを蓄える時期です。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>二十六夜月は新月直前、光が最も細くなった月</li>
      <li>「静けさ」「内省」を象徴し、一巡りの締めくくりの時期</li>
      <li>休息や振り返りを大切にする過ごし方がおすすめ</li>
      <li>大きな決断や新しい挑戦は次の新月まで待つのが良いとされる</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/moon/kagen/';
  $prevTitle = '下弦の月';
  $nextUrl   = null;
  $nextTitle = null;
  ...
  <section class="art-section" id="related">
    ...
    <?php
    $relatedItems = [
      ['label'=>'十三夜月とは', 'title'=>'対になる月相を知る →', 'url'=>'/articles/calendar/moon/juusanya/'],
      ['label'=>'新月とは', 'title'=>'このサイクルの始まりを知る →', 'url'=>'/articles/calendar/moon/shingetsu/'],
...
<?php $currentSlug='nijuurokuya'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'nijuurokuya');
?>
