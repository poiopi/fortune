...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/moon/kagen/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="下弦の月の意味・スピリチュアルな解釈・おすすめの過ごし方を解説。手放しと整理を象徴する半月にすべきことを紹介します。">
  <title>下弦の月とは？意味と過ごし方をわかりやすく解説｜月相ガイド</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"下弦の月はいつ見えますか？","acceptedAnswer":{"@type":"Answer","text":"下弦の月は真夜中に昇り、日中の空に見えることが多い月相です。上弦の月とは見える時間帯が逆になります。"}},
      {"@type":"Question","name":"下弦の月の日に新しいことを始めても良いですか？","acceptedAnswer":{"@type":"Answer","text":"占いの考え方では、下弦の月は「手放し」「整理」の時期とされ、新しいことを始めるより身の回りを整える方が向いているとされています。"}},
      {"@type":"Question","name":"下弦の月の日に向いていることは？","acceptedAnswer":{"@type":"Answer","text":"部屋やデータの整理、不要な習慣の見直しなど「引き算」の行動が向いているとされています。"}}
    ]
  }
  </script>
...
<div class="wrap">
  ...
  <div class="art-hero">
    <span class="art-label">KAGEN · 月相</span>
    <h1>下弦の月とは？<br>意味と過ごし方をわかりやすく解説</h1>
    <p class="art-lead">下弦の月（かげんのつき）は、満月から新月へ向かう過程で、月の左半分が輝いて見える半月です。手放しと整理を象徴する月相とされています。</p>
  </div>

  <dl class="basic-info">
    <dt>読み方</dt><dd>かげんのつき</dd>
    <dt>英語名</dt><dd>Last Quarter Moon</dd>
    <dt>月齢</dt><dd>20.3〜24.0</dd>
    <dt>見え方</dt><dd>左半分が輝いて見える半月（上弦の月と対称）</dd>
  </dl>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">下弦の月とは</a></li>
      <li><a href="#spiritual">下弦の月が持つスピリチュアルな意味</a></li>
      <li><a href="#action">下弦の月におすすめの過ごし方</a></li>
      <li><a href="#avoid">下弦の月に避けたいこと</a></li>
      <li><a href="#today">今日が下弦の月の日なら</a></li>
  ...
  <section class="art-section" id="about">
    <h2>下弦の月とは</h2>
    <p>下弦の月は、満月から新月へ向かう過程で、月の左半分（南半球では右半分）が輝いて見える半月です。上弦の月とちょうど対称的な形をしており、月齢はおよそ22日前後になります。</p>
  </section>

  <section class="art-section" id="spiritual">
    <h2>下弦の月が持つスピリチュアルな意味</h2>
    <p>満月を過ぎ、光が少しずつ欠けていくこの時期は、手放しや整理の象徴とされています。上弦の月が「積み上げる」時期だとすれば、下弦の月は「削ぎ落とす」時期。不要なものを見直すのに適したタイミングです。</p>
  </section>

  <section class="art-section" id="action">
    <h2>下弦の月におすすめの過ごし方</h2>
    <p>部屋やデータの整理、人間関係の見直し、不要な習慣を手放すなど「引き算」の行動に向いています。心身ともに身軽になることを意識してみてください。</p>
  </section>

  <section class="art-section" id="avoid">
    <h2>下弦の月に避けたいこと</h2>
    <p>新しいことを無理に始めようとすると、エネルギーが十分でなく息切れしやすい時期です。この時期は「始める」より「整える」ことを優先しましょう。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が下弦の月の日なら</h2>
    <p>身の回りで一つ、手放せるものや見直せることを探してみてください。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">下弦の月はいつ見えますか？</div>
        <div class="faq-a">下弦の月は真夜中に昇り、日中の空に見えることが多い月相です。上弦の月とは見える時間帯が逆になります。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">下弦の月の日に新しいことを始めても良いですか？</div>
        <div class="faq-a">占いの考え方では、下弦の月は「手放し」「整理」の時期とされ、新しいことを始めるより身の回りを整える方が向いているとされています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">下弦の月の日に向いていることは？</div>
        <div class="faq-a">部屋やデータの整理、不要な習慣の見直しなど「引き算」の行動が向いているとされています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>下弦の月は満月と新月の中間、左半分が輝く半月</li>
      <li>「手放し」「整理」を象徴し、削ぎ落とす時期とされる</li>
      <li>部屋の整理や人間関係の見直しなど引き算の行動に向く</li>
      <li>新しいことを無理に始めるより、整えることを優先したい時期</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/moon/izayoi/';
  $prevTitle = '十六夜月';
...
<?php $currentSlug='kagen'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'kagen');
?>
