...
<head>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"上弦の月と下弦の月の違いは何ですか？","acceptedAnswer":{"@type":"Answer","text":"上弦の月は新月から満月に向かう過程の半月、下弦の月は満月から新月に向かう過程の半月です。上弦は「満ちていく」、下弦は「欠けていく」段階にあるという違いがあります。"}},
      {"@type":"Question","name":"上弦の月はいつ見えますか？","acceptedAnswer":{"@type":"Answer","text":"上弦の月は夕方から夜半にかけて空高く見え、真夜中前に沈みます。日没後の空で見つけやすい月相です。"}},
      {"@type":"Question","name":"上弦の月の日に向いていることは？","acceptedAnswer":{"@type":"Answer","text":"決断や行動、新しい挑戦に向いているとされています。ここまで温めてきた計画を実行に移すタイミングとして良いとされています。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":5,"name":"上弦の月とは","item":"https://life-fun.net/articles/calendar/moon/jougen/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/moon/">月の満ち欠けとは</a><span>›</span>上弦の月とは
  </nav>

  <div class="art-hero">
    <span class="art-label">JOUGEN · 月相</span>
    <h1>上弦の月とは？<br>意味と過ごし方をわかりやすく解説</h1>
    <p class="art-lead">上弦の月（じょうげんのつき）は、月の右半分が輝いて見える半月です。新月から満月へ向かう過程のちょうど中間地点にあたり、決断と行動を象徴する月相とされています。</p>
  </div>

  <dl class="basic-info">
    <dt>読み方</dt><dd>じょうげんのつき</dd>
    <dt>英語名</dt><dd>First Quarter Moon</dd>
    <dt>月齢</dt><dd>5.5〜9.2</dd>
    <dt>見え方</dt><dd>右半分が輝いて見える半月</dd>
  </dl>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">上弦の月とは</a></li>
      <li><a href="#spiritual">上弦の月が持つスピリチュアルな意味</a></li>
      <li><a href="#action">上弦の月におすすめの過ごし方</a></li>
      <li><a href="#avoid">上弦の月に避けたいこと</a></li>
      <li><a href="#today">今日が上弦の月の日なら</a></li>
  ...
  <section class="art-section" id="about">
    <h2>上弦の月とは</h2>
    <p>上弦の月は、月の右半分（南半球では左半分）が輝いて見える半月です。新月から満月へ向かう過程のちょうど中間地点にあたり、月齢はおよそ7日前後になります。</p>
  </section>

  <section class="art-section" id="spiritual">
    <h2>上弦の月が持つスピリチュアルな意味</h2>
    <p>半分は光、半分は影という姿から、決断と行動の象徴とされています。ここまで積み重ねてきたことが試される時期でもあり、迷いを断ち切って前へ進む勢いをつけるタイミングとして知られています。</p>
  </section>

  <section class="art-section" id="action">
    <h2>上弦の月におすすめの過ごし方</h2>
    <p>迷っていたことを決断する、行動を起こす、障害があれば工夫して乗り越えるなど、積極的に動くのに向いた時期です。人との交渉や新しい挑戦にも良いタイミングとされています。</p>
  </section>

  <section class="art-section" id="avoid">
    <h2>上弦の月に避けたいこと</h2>
    <p>勢いのある時期だからこそ、周囲との摩擦や衝動的な判断には注意が必要です。焦って強引に進めるより、着実な一歩を意識しましょう。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が上弦の月の日なら</h2>
    <p>先延ばしにしていたことを一つ、思い切って決めてみる日にしてみてください。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">上弦の月と下弦の月の違いは何ですか？</div>
        <div class="faq-a">上弦の月は新月から満月に向かう過程の半月、下弦の月は満月から新月に向かう過程の半月です。上弦は「満ちていく」、下弦は「欠けていく」段階にあるという違いがあります。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">上弦の月はいつ見えますか？</div>
        <div class="faq-a">上弦の月は夕方から夜半にかけて空高く見え、真夜中前に沈みます。日没後の空で見つけやすい月相です。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">上弦の月の日に向いていることは？</div>
        <div class="faq-a">決断や行動、新しい挑戦に向いているとされています。ここまで温めてきた計画を実行に移すタイミングとして良いとされています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>上弦の月は新月と満月のちょうど中間、右半分が輝く半月</li>
      <li>「決断」「行動」を象徴し、迷いを断ち切るタイミングとされる</li>
      <li>積極的な行動・交渉・新しい挑戦に向く時期</li>
      <li>衝動的にならないよう、着実さも意識したい</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/moon/mikazuki/';
  $prevTitle = '三日月';
  $nextUrl   = '/articles/calendar/moon/juusanya/';
  $nextTitle = '十三夜月';
  ...
  <section class="art-section" id="related">
    ...
    <?php
    $relatedItems = [
      ['label'=>'下弦の月とは', 'title'=>'対になる月相を知る →', 'url'=>'/articles/calendar/moon/kagen/'],
      ['label'=>'十三夜月とは', 'title'=>'次の月相を知る →', 'url'=>'/articles/calendar/moon/juusanya/'],
...
<?php $currentSlug='jougen'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'jougen');
?>
