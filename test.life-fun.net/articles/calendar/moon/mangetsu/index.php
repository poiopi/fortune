...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/moon/mangetsu/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="満月の意味・スピリチュアルな解釈・おすすめの過ごし方を解説。物事の集大成を象徴する月相にすべきことを紹介します。">
  <title>満月とは？意味と過ごし方をわかりやすく解説｜月相ガイド</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"満月はどのくらいの頻度でありますか？","acceptedAnswer":{"@type":"Answer","text":"満月はおよそ29.5日（1朔望月）に一度訪れます。1年におよそ12〜13回、まれに1ヶ月に2回満月が起こる「ブルームーン」という現象もあります。"}},
      {"@type":"Question","name":"満月の日は運気が不安定になるというのは本当ですか？","acceptedAnswer":{"@type":"Answer","text":"占いやスピリチュアルの分野では、満月はエネルギーが高まる時期とされ、感情が揺れやすいと言われることがあります。ただし科学的に実証されたものではなく、あくまで一つの考え方として参考にする程度がおすすめです。"}},
      {"@type":"Question","name":"満月の日に向いていることは？","acceptedAnswer":{"@type":"Answer","text":"これまでの努力を振り返り、成果に感謝する過ごし方が向いているとされています。達成や集大成を象徴する日です。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":5,"name":"満月とは","item":"https://life-fun.net/articles/calendar/moon/mangetsu/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/moon/">月の満ち欠けとは</a><span>›</span>満月とは
  </nav>

  <div class="art-hero">
    <span class="art-label">MANGETSU · 月相</span>
    <h1>満月とは？<br>意味と過ごし方をわかりやすく解説</h1>
    <p class="art-lead">満月（まんげつ）は、地球から見て太陽の光を最も多く受けた月の面が見える、丸く満ちた状態です。新月から数えておよそ15日目、物事の集大成を象徴する月相とされています。</p>
  </div>

  <dl class="basic-info">
    <dt>読み方</dt><dd>まんげつ</dd>
    <dt>英語名</dt><dd>Full Moon</dd>
    <dt>月齢</dt><dd>12.9〜16.6</dd>
    <dt>見え方</dt><dd>丸く満ちて輝く、最も明るい状態の月</dd>
  </dl>

  <?php
  $ctaTitle = '📅 今日の月齢を確認する';
  $ctaText  = '新月・満月など今日の月相を毎日更新でお届け。';
  $ctaUrl   = '/calendar';
  $ctaBtn   = '開運カレンダーを見る →';
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">満月とは</a></li>
      <li><a href="#spiritual">満月が持つスピリチュアルな意味</a></li>
      <li><a href="#action">満月におすすめの過ごし方</a></li>
      <li><a href="#avoid">満月に避けたいこと</a></li>
      <li><a href="#today">今日が満月の日なら</a></li>
  ...
  <section class="art-section" id="about">
    <h2>満月とは</h2>
    <p>満月は、地球から見て太陽の光を最も多く受けた月の面が見える、丸く満ちた状態です。新月から数えておよそ15日目、一朔望月のちょうど折り返し地点にあたり、夜空を最も明るく照らします。</p>
  </section>

  <section class="art-section" id="spiritual">
    <h2>満月が持つスピリチュアルな意味</h2>
    <p>満月は物事の集大成、達成の象徴として古くから世界中で特別な日とされてきました。新月で蒔いた種が実を結ぶタイミングであり、感謝や振り返りにふさわしい日とされています。</p>
  </section>

  <section class="art-section" id="action">
    <h2>満月におすすめの過ごし方</h2>
    <p>これまでの努力を振り返り、成果に感謝する時間を持つのがおすすめです。満月の光を浴びながら過ごす、感謝の気持ちを言葉にする、達成できたことを自分でねぎらうといった過ごし方が向いています。</p>
  </section>

  <section class="art-section" id="avoid">
    <h2>満月に避けたいこと</h2>
    <p>エネルギーが高まりやすい時期のため、感情的になりすぎたり、衝動的な行動に出たりしないよう注意が必要です。興奮した状態での大きな決断は避けた方が良いとされています。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が満月の日なら</h2>
    <p>今日一日を振り返り、小さなことでも「できたこと」に目を向けてみてください。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">満月はどのくらいの頻度でありますか？</div>
        <div class="faq-a">満月はおよそ29.5日（1朔望月）に一度訪れます。1年におよそ12〜13回、まれに1ヶ月に2回満月が起こる「ブルームーン」という現象もあります。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">満月の日は運気が不安定になるというのは本当ですか？</div>
        <div class="faq-a">占いやスピリチュアルの分野では、満月はエネルギーが高まる時期とされ、感情が揺れやすいと言われることがあります。ただし科学的に実証されたものではなく、あくまで一つの考え方として参考にする程度がおすすめです。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">満月の日に向いていることは？</div>
        <div class="faq-a">これまでの努力を振り返り、成果に感謝する過ごし方が向いているとされています。達成や集大成を象徴する日です。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>満月は月が最も丸く満ちて輝く、朔望月の折り返し地点</li>
      <li>「集大成」「達成」を象徴し、感謝や振り返りにふさわしい日</li>
      <li>成果をねぎらう、感謝を言葉にするといった過ごし方がおすすめ</li>
      <li>エネルギーが高まる時期なので衝動的な判断には注意</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/moon/juusanya/';
  $prevTitle = '十三夜月';
  $nextUrl   = '/articles/calendar/moon/izayoi/';
  $nextTitle = '十六夜月';
  ...
  <section class="art-section" id="related">
    <h2>関連コンテンツ</h2>
    <p>月相についてさらに詳しく知りたい方はこちら。</p>
    <?php
    $relatedItems = [
      ['label'=>'新月とは', 'title'=>'対になる月相を知る →', 'url'=>'/articles/calendar/moon/shingetsu/'],
      ['label'=>'十六夜月とは', 'title'=>'次の月相を知る →', 'url'=>'/articles/calendar/moon/izayoi/'],
...
<?php $currentSlug='mangetsu'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'mangetsu');
?>
