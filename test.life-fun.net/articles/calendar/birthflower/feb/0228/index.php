  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"2月28日の誕生花（ロウバイ）とは","item":"https://life-fun.net/articles/calendar/birthflower/feb/0228/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/feb/">2月の誕生花とは</a><span>›</span>2月28日の誕生花（ロウバイ）とは
  </nav>
  ...
  <section class="art-section" id="experience">
    ...
    <p class="cta-lead">寒い季節にほっと一息つけた今日は、六曜の並びも眺めてみませんか。開運カレンダーでは、その日の六曜や年九星もあわせて調べられます。</p>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/feb/0227/';
  $prevTitle = '2月27日の誕生花（ミルトニア）とは';
  $nextUrl   = '/articles/calendar/birthflower/feb/0229/';
  $nextTitle = '2月29日の誕生花（パンジー）とは';
...
<?php $currentSlug='calendar-birthflower-feb-0228'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-feb-0228');
?>
