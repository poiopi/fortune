...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/birthflower/feb/0201/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="2月1日の誕生花フリージア（黄）の花言葉・特徴・魅力をわかりやすく解説。「純愛」を象徴する春の香り高い花の意味を紹介します。">
  <title>2月1日の誕生花はフリージア（黄）｜花言葉と魅力をわかりやすく解説</title>
...
<div class="wrap">
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jan/0131/';
  $prevTitle = '1月31日の誕生花（ウメ（白））とは';
  $nextUrl   = '/articles/calendar/birthflower/feb/0202/';
  $nextTitle = '2月2日の誕生花（シラー）とは';
...
<?php $currentSlug='calendar-birthflower-feb-0201'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-feb-0201');
?>
