  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"3月30日の誕生花（ゲッケイジュ）とは","item":"https://life-fun.net/articles/calendar/birthflower/mar/0330/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/mar/">3月の誕生花とは</a><span>›</span>3月30日の誕生花（ゲッケイジュ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ゲッケイジュ</dd>
    <dt>花言葉</dt><dd>栄誉と勝利</dd>
    <dt>科名</dt><dd>クスノキ科</dd>
    <dt>見頃</dt><dd>春</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/mar/0329/';
  $prevTitle = '3月29日の誕生花（イカリソウ）とは';
  $nextUrl   = '/articles/calendar/birthflower/mar/0331/';
  $nextTitle = '3月31日の誕生花（キンセンカ）とは';
...
<?php $currentSlug='calendar-birthflower-mar-0330'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-mar-0330');
?>
