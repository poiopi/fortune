  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"3月12日の誕生花（キャンディタフト）とは","item":"https://life-fun.net/articles/calendar/birthflower/mar/0312/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/mar/">3月の誕生花とは</a><span>›</span>3月12日の誕生花（キャンディタフト）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/mar/0311/';
  $prevTitle = '3月11日の誕生花（ヒガンザクラ）とは';
  $nextUrl   = '/articles/calendar/birthflower/mar/0313/';
  $nextTitle = '3月13日の誕生花（ノースポール）とは';
...
<?php $currentSlug='calendar-birthflower-mar-0312'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-mar-0312');
?>
