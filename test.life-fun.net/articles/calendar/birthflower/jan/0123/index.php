...
<div class="wrap">
  ...
  <section class="art-section" id="experience">
    ...
    <p class="cta-lead">背筋を伸ばして過ごせた今日は、運気の流れも一緒に確認してみませんか。開運カレンダーでは、日々の年九星もわかります。</p>
  </section>
...
<?php $currentSlug='calendar-birthflower-jan-0123'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jan-0123');
?>
