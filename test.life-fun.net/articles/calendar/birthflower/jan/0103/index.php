...
<div class="wrap">
  ...
  <section class="art-section" id="experience">
    ...
    <p class="cta-lead">自分らしさを見つめ直した今日は、運気の流れもあわせて確認してみると新たな発見があるかもしれません。開運カレンダーでは、日々のラッキーカラーや星座も紹介しています。</p>
  </section>
...
<?php $currentSlug='calendar-birthflower-jan-0103'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jan-0103');
?>
