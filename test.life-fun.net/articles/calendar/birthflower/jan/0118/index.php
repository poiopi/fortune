...
<div class="wrap">
  ...
  <section class="art-section" id="experience">
    ...
    <p class="cta-lead">身の回りが少し整った今日は、運気の流れもあわせて確認してみませんか。開運カレンダーでは、日々のおすすめの行動もわかります。</p>
  </section>
...
<?php $currentSlug='calendar-birthflower-jan-0118'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jan-0118');
?>
