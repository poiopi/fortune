  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"7月11日の誕生花（インパチェンス）とは","item":"https://life-fun.net/articles/calendar/birthflower/jul/0711/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jul/">7月の誕生花とは</a><span>›</span>7月11日の誕生花（インパチェンス）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>インパチェンス</dd>
    <dt>花言葉</dt><dd>鮮やかな人</dd>
    <dt>科名</dt><dd>ツリフネソウ科</dd>
    <dt>見頃</dt><dd>夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jul/0710/';
  $prevTitle = '7月10日の誕生花（マツバボタン）とは';
  $nextUrl   = '/articles/calendar/birthflower/jul/0712/';
  $nextTitle = '7月12日の誕生花（パッションフラワー）とは';
...
<?php $currentSlug='calendar-birthflower-jul-0711'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jul-0711');
?>