  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"6月1日の誕生花（クレマチス）とは","item":"https://life-fun.net/articles/calendar/birthflower/jun/0601/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jun/">6月の誕生花とは</a><span>›</span>6月1日の誕生花（クレマチス）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/may/0531/';
  $prevTitle = '5月31日の誕生花（キショウブ）とは';
  $nextUrl   = '/articles/calendar/birthflower/jun/0602/';
  $nextTitle = '6月2日の誕生花（シャクナゲ）とは';
...
<?php $currentSlug='calendar-birthflower-jun-0601'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jun-0601');
?>