  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"6月29日の誕生花（ペラルゴニウム）とは","item":"https://life-fun.net/articles/calendar/birthflower/jun/0629/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jun/">6月の誕生花とは</a><span>›</span>6月29日の誕生花（ペラルゴニウム）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ペラルゴニウム</dd>
    <dt>花言葉</dt><dd>あでやか</dd>
    <dt>科名</dt><dd>フウロソウ科</dd>
    <dt>見頃</dt><dd>初夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jun/0628/';
  $prevTitle = '6月28日の誕生花（ツルハナナス）とは';
  $nextUrl   = '/articles/calendar/birthflower/jun/0630/';
  $nextTitle = '6月30日の誕生花（ヘリオトロープ）とは';
...
<?php $currentSlug='calendar-birthflower-jun-0629'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jun-0629');
?>
