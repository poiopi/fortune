  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"6月8日の誕生花（レースフラワー）とは","item":"https://life-fun.net/articles/calendar/birthflower/jun/0608/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jun/">6月の誕生花とは</a><span>›</span>6月8日の誕生花（レースフラワー）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>レースフラワー</dd>
    <dt>花言葉</dt><dd>優雅なたしなみ</dd>
    <dt>科名</dt><dd>セリ科</dd>
    <dt>見頃</dt><dd>初夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jun/0607/';
  $prevTitle = '6月7日の誕生花（カルセオラリア）とは';
  $nextUrl   = '/articles/calendar/birthflower/jun/0609/';
  $nextTitle = '6月9日の誕生花（ゴデチア）とは';
...
<?php $currentSlug='calendar-birthflower-jun-0608'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jun-0608');
?>