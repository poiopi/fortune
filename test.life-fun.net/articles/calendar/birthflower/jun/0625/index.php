  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"6月25日の誕生花（アガパンサス）とは","item":"https://life-fun.net/articles/calendar/birthflower/jun/0625/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jun/">6月の誕生花とは</a><span>›</span>6月25日の誕生花（アガパンサス）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>アガパンサス</dd>
    <dt>花言葉</dt><dd>愛の始まり</dd>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jun/0624/';
  $prevTitle = '6月24日の誕生花（バラ（赤））とは';
  $nextUrl   = '/articles/calendar/birthflower/jun/0626/';
  $nextTitle = '6月26日の誕生花（レッドクローバー）とは';
...
<?php $currentSlug='calendar-birthflower-jun-0625'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jun-0625');
?>
