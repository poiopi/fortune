  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"6月12日の誕生花（ベロペロネ）とは","item":"https://life-fun.net/articles/calendar/birthflower/jun/0612/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jun/">6月の誕生花とは</a><span>›</span>6月12日の誕生花（ベロペロネ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jun/0611/';
  $prevTitle = '6月11日の誕生花（ガクアジサイ）とは';
  $nextUrl   = '/articles/calendar/birthflower/jun/0613/';
  $nextTitle = '6月13日の誕生花（クチナシ）とは';
...
<?php $currentSlug='calendar-birthflower-jun-0612'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jun-0612');
?>
