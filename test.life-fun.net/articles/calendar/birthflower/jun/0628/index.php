  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"6月28日の誕生花（ツルハナナス）とは","item":"https://life-fun.net/articles/calendar/birthflower/jun/0628/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jun/">6月の誕生花とは</a><span>›</span>6月28日の誕生花（ツルハナナス）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ツルハナナス</dd>
    <dt>花言葉</dt><dd>ほほえみ</dd>
    <dt>科名</dt><dd>ナス科</dd>
    <dt>見頃</dt><dd>夏〜秋</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jun/0627/';
  $prevTitle = '6月27日の誕生花（サンダーソニア）とは';
  $nextUrl   = '/articles/calendar/birthflower/jun/0629/';
  $nextTitle = '6月29日の誕生花（ペラルゴニウム）とは';
...
<?php $currentSlug='calendar-birthflower-jun-0628'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jun-0628');
?>