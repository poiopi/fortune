  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"12月26日の誕生花（リュウノヒゲ）とは","item":"https://life-fun.net/articles/calendar/birthflower/dec/1226/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/dec/">12月の誕生花とは</a><span>›</span>12月26日の誕生花（リュウノヒゲ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>リュウノヒゲ</dd>
    <dt>花言葉</dt><dd>天才的</dd>
    <dt>科名</dt><dd>キジカクシ科</dd>
    <dt>見頃</dt><dd>夏（花）／冬（実）</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/dec/1225/';
  $prevTitle = '12月25日の誕生花（クリスマスパレード）とは';
  $nextUrl   = '/articles/calendar/birthflower/dec/1227/';
  $nextTitle = '12月27日の誕生花（ヒイラギ）とは';
