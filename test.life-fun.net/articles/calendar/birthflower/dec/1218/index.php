  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"12月18日の誕生花（ヘリコニア）とは","item":"https://life-fun.net/articles/calendar/birthflower/dec/1218/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/dec/">12月の誕生花とは</a><span>›</span>12月18日の誕生花（ヘリコニア）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ヘリコニア</dd>
    <dt>花言葉</dt><dd>注目</dd>
    <dt>科名</dt><dd>ヘリコニア科</dd>
    <dt>見頃</dt><dd>夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/dec/1217/';
  $prevTitle = '12月17日の誕生花（キルタンサス）とは';
  $nextUrl   = '/articles/calendar/birthflower/dec/1219/';
  $nextTitle = '12月19日の誕生花（ベゴニア（ピンク））とは';
