  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"5月1日の誕生花（マーガレット）とは","item":"https://life-fun.net/articles/calendar/birthflower/may/0501/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/may/">5月の誕生花とは</a><span>›</span>5月1日の誕生花（マーガレット）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>マーガレット</dd>
    <dt>花言葉</dt><dd>秘めた愛</dd>
    <dt>科名</dt><dd>キク科</dd>
    <dt>見頃</dt><dd>春</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/apr/0430/';
  $prevTitle = '4月30日の誕生花（ムラサキハナナ）とは';
  $nextUrl   = '/articles/calendar/birthflower/may/0502/';
  $nextTitle = '5月2日の誕生花（シバザクラ）とは';
...
<?php $currentSlug='calendar-birthflower-may-0501'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-may-0501');
?>
