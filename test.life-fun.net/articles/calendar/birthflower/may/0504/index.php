  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"5月4日の誕生花（シャクヤク）とは","item":"https://life-fun.net/articles/calendar/birthflower/may/0504/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/may/">5月の誕生花とは</a><span>›</span>5月4日の誕生花（シャクヤク）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>シャクヤク</dd>
    <dt>花言葉</dt><dd>恥じらい</dd>
    <dt>科名</dt><dd>ボタン科</dd>
    <dt>見頃</dt><dd>初夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/may/0503/';
  $prevTitle = '5月3日の誕生花（フロックス）とは';
  $nextUrl   = '/articles/calendar/birthflower/may/0505/';
  $nextTitle = '5月5日の誕生花（ハナショウブ）とは';
...
<?php $currentSlug='calendar-birthflower-may-0504'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-may-0504');
?>
