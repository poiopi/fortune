  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"5月15日の誕生花（アヤメ）とは","item":"https://life-fun.net/articles/calendar/birthflower/may/0515/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/may/">5月の誕生花とは</a><span>›</span>5月15日の誕生花（アヤメ）とは
  </nav>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <p>日によって少しずつ違う顔を見せる網目模様は、気まぐれというより自由さの証ではないでしょうか。揺れ動く気持ちも、アヤメらしい個性の一部です。</p>
    <ul>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/may/0514/';
  $prevTitle = '5月14日の誕生花（フクシア）とは';
  $nextUrl   = '/articles/calendar/birthflower/may/0516/';
  $nextTitle = '5月16日の誕生花（ゼラニウム）とは';
...
<?php $currentSlug='calendar-birthflower-may-0515'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-may-0515');
?>
