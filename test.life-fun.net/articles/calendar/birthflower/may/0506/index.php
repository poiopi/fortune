  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"5月6日の誕生花（ユズ）とは","item":"https://life-fun.net/articles/calendar/birthflower/may/0506/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/may/">5月の誕生花とは</a><span>›</span>5月6日の誕生花（ユズ）とは
  </nav>
  ...
  <section class="art-section" id="about">
    ...
    <p>ユズは、ミカン科の常緑低木です。冬に実る果実の香りでよく知られていますが、花も同じ木に咲きます。初夏になると白く香り高い花を咲かせ、開花の時期と果実が実る時期は異なる季節にあたります。花と実、二つの季節で楽しめる清々しく実り豊かな植物として、5月6日の誕生花に選ばれています。</p>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/may/0505/';
  $prevTitle = '5月5日の誕生花（ハナショウブ）とは';
  $nextUrl   = '/articles/calendar/birthflower/may/0507/';
  $nextTitle = '5月7日の誕生花（ナスタチウム）とは';
...
<?php $currentSlug='calendar-birthflower-may-0506'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-may-0506');
?>
