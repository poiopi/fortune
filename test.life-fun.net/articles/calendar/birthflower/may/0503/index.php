  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"5月3日の誕生花（フロックス）とは","item":"https://life-fun.net/articles/calendar/birthflower/may/0503/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/may/">5月の誕生花とは</a><span>›</span>5月3日の誕生花（フロックス）とは
  </nav>

  <div class="art-hero">
    <span class="art-label">MAY 3 · 誕生花</span>
    <h1>5月3日の誕生花はフロックス<br>花言葉と魅力をわかりやすく解説</h1>
    <p class="art-lead">新緑の香りに初夏の気配を感じ始める5月、房のように連なって咲くフロックスが少しずつ蕾をふくらませる頃です。少しずつ膨らむ蕾に宿る、寄り添う花たちの静かな気配。</p>
  </div>

  <dl class="basic-info">
    <dt>花名</dt><dd>フロックス</dd>
    <dt>花言葉</dt><dd>温和</dd>
  ...
  <section class="art-section" id="message">
    ...
    <div class="hana-message">
      ...
      <p>何十もの小さな花が寄り添って、一つの大きな房になる。小さな積み重ねが、確かな強さの土台になります。</p>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <p>何十もの小さな花が身を寄せ合い、初夏の庭にふっくらとした房を作り上げる季節。穏やかに寄り添う姿の先に広がる、確かな強さという名の景色。</p>
    <ul>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/may/0502/';
  $prevTitle = '5月2日の誕生花（シバザクラ）とは';
  $nextUrl   = '/articles/calendar/birthflower/may/0504/';
  $nextTitle = '5月4日の誕生花（シャクヤク）とは';
...
<?php $currentSlug='calendar-birthflower-may-0503'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-may-0503');
?>
