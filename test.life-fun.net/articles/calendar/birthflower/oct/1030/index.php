...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/birthflower/oct/1030/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="10月30日の誕生花クロッカス（紫）の花言葉・特徴・魅力をわかりやすく解説。「エネルギー」を象徴する紫色の花の意味を紹介します。">
  <title>10月30日の誕生花はクロッカス（紫）｜花言葉と魅力をわかりやすく解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"10月30日の誕生花（クロッカス（紫））とは","item":"https://life-fun.net/articles/calendar/birthflower/oct/1030/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/oct/">10月の誕生花とは</a><span>›</span>10月30日の誕生花（クロッカス（紫））とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>クロッカス（紫）</dd>
    <dt>花言葉</dt><dd>エネルギー</dd>
    <dt>科名</dt><dd>アヤメ科</dd>
    <dt>見頃</dt><dd>早春</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/oct/1029/';
  $prevTitle = '10月29日の誕生花（アングレカム）とは';
  $nextUrl   = '/articles/calendar/birthflower/oct/1031/';
  $nextTitle = '10月31日の誕生花（タマスダレ）とは';
...
<?php $currentSlug='calendar-birthflower-oct-1030'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-oct-1030');
?>