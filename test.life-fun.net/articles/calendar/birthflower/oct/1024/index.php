  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"10月24日の誕生花（パボニア）とは","item":"https://life-fun.net/articles/calendar/birthflower/oct/1024/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/oct/">10月の誕生花とは</a><span>›</span>10月24日の誕生花（パボニア）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/oct/1023/';
  $prevTitle = '10月23日の誕生花（ダリア）とは';
  $nextUrl   = '/articles/calendar/birthflower/oct/1025/';
  $nextTitle = '10月25日の誕生花（ヘレニウム）とは';
...
<?php $currentSlug='calendar-birthflower-oct-1024'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-oct-1024');
?>