  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"11月24日の誕生花（フユボタン）とは","item":"https://life-fun.net/articles/calendar/birthflower/nov/1124/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/nov/">11月の誕生花とは</a><span>›</span>11月24日の誕生花（フユボタン）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/nov/1123/';
  $prevTitle = '11月23日の誕生花（バラ（白））とは';
  $nextUrl   = '/articles/calendar/birthflower/nov/1125/';
  $nextTitle = '11月25日の誕生花（コチョウラン）とは';
...
<?php $currentSlug='calendar-birthflower-nov-1124'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-nov-1124');
?>