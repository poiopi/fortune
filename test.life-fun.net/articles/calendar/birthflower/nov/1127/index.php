  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"11月27日の誕生花（クロッサンドラ）とは","item":"https://life-fun.net/articles/calendar/birthflower/nov/1127/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/nov/">11月の誕生花とは</a><span>›</span>11月27日の誕生花（クロッサンドラ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>クロッサンドラ</dd>
    <dt>花言葉</dt><dd>内面の美</dd>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/nov/1126/';
  $prevTitle = '11月26日の誕生花（シーマンニア）とは';
  $nextUrl   = '/articles/calendar/birthflower/nov/1128/';
  $nextTitle = '11月28日の誕生花（クリ）とは';
...
<?php $currentSlug='calendar-birthflower-nov-1127'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-nov-1127');
?>