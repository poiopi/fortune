  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"11月5日の誕生花（デンファレ）とは","item":"https://life-fun.net/articles/calendar/birthflower/nov/1105/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/nov/">11月の誕生花とは</a><span>›</span>11月5日の誕生花（デンファレ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>デンファレ</dd>
    <dt>花言葉</dt><dd>お似合い</dd>
    <dt>科名</dt><dd>ラン科</dd>
    <dt>見頃</dt><dd>夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/nov/1104/';
  $prevTitle = '11月4日の誕生花（ピラカンサ）とは';
  $nextUrl   = '/articles/calendar/birthflower/nov/1106/';
  $nextTitle = '11月6日の誕生花（カーネーション（白））とは';
...
<?php $currentSlug='calendar-birthflower-nov-1105'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-nov-1105');
?>