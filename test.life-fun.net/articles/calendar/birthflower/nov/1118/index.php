...
<head>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"カラー（黄）の花びらのように見える部分は何ですか？","acceptedAnswer":{"@type":"Answer","text":"花びらではなく苞と呼ばれる葉が変化した部分で、内側に小さな花が集まっています。"}},
      {"@type":"Question","name":"カラー（黄）の花言葉「熱意」はどう結びついていますか？","acceptedAnswer":{"@type":"Answer","text":"見た人の視線を思わずとらえる、その鮮やかな黄色の力強さを象徴すると言われています。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"11月18日の誕生花（カラー（黄））とは","item":"https://life-fun.net/articles/calendar/birthflower/nov/1118/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/nov/">11月の誕生花とは</a><span>›</span>11月18日の誕生花（カラー（黄））とは
  </nav>

  <div class="art-hero">
    <span class="art-label">NOVEMBER 18 · 誕生花</span>
    <h1>11月18日の誕生花はカラー（黄）<br>花言葉と魅力をわかりやすく解説</h1>
    <p class="art-lead">サトイモ科の多年草、カラー（黄）は、黄色い苞に包まれた鮮やかな花を初夏に咲かせる。その黄色に宿る情熱が、なぜ11月18日という寒さ深まる時期の誕生花に選ばれたのだろうか。</p>
  </div>

  <dl class="basic-info">
    <dt>花名</dt><dd>カラー（黄）</dd>
    <dt>花言葉</dt><dd>熱意</dd>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">11月18日の誕生花として親しまれるカラー（黄）</a></li>
      <li><a href="#story">苞に包まれた、黄色い情熱</a></li>
      <li><a href="#message">🌼今日の誕生花からのメッセージ</a></li>
      <li><a href="#experience">今日、カラー（黄）から始める小さな体験</a></li>
      <li><a href="#matome">まとめ</a></li>
    </ol>
  </nav>

  <section class="art-section" id="about">
    <h2>11月18日の誕生花として親しまれるカラー（黄）</h2>
    <p>カラー（黄）は、サトイモ科の多年草として知られる、11月18日の誕生花です。花が咲くのは初夏ですが、黄色い苞に包まれた明るい花姿にちなみ、熱意を象徴する花としてこの日に選ばれています。</p>

    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">カラー（黄）の花びらのように見える部分は何ですか？</div>
        <div class="faq-a">花びらではなく苞と呼ばれる葉が変化した部分で、内側に小さな花が集まっています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="story">
    <h2>苞に包まれた、黄色い情熱</h2>
    <p>黄色い苞にすっぽりと包まれた花が、庭先で目に飛び込んでくることがある。サトイモ科の多年草、カラー（黄）が花を咲かせるのは初夏だが、その鮮やかな黄色は一度見たら忘れられないほど強い印象を残す。花びらのように見える部分は実は苞と呼ばれる葉が変化したもので、内側には小さな花が密集して並んでいる。この一目で人の視線を引き寄せる黄色の存在感が、「熱意」という花言葉を象徴する。</p>

    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">カラー（黄）の花言葉「熱意」はどう結びついていますか？</div>
        <div class="faq-a">見た人の視線を思わずとらえる、その鮮やかな黄色の力強さを象徴すると言われています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="message">
    ...
    <div class="hana-message">
      ...
      <p>内側にある熱意は、抑え込むほど行き場を失っていく。声に出す、行動に移す、色で表す——表現の仕方は人それぞれでいい。今日はその熱を、誰かに見える形にして届けたい。</p>
    </div>
  </section>

  <section class="art-section" id="experience">
    <h2>今日、カラー（黄）から始める小さな体験</h2>
    <p>苞の内側に情熱を秘めて鮮やかに咲くカラー（黄）にならって、今日はこんな時間を過ごしてみませんか。</p>
    <ul class="exp-list">
      <li>黄色い苞の形をじっくり観察してみる</li>
      <li>心の中の熱意を一つ、行動に移してみる</li>
      <li>黄色いものを身の回りに取り入れてみる</li>
    </ul>

    <p class="cta-lead">気持ちを盛り上げたい日は、開運カレンダーで今日のラッキーカラーも確認してみませんか。</p>
  </section>

  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <p>同じカラーでも、白より黄色のほうがどこか力強い印象を放つ。</p>
    <ul>
      <li>カラー（黄）は、サトイモ科の多年草で、黄色い苞に包まれた花を咲かせる、11月18日の誕生花</li>
      <li>花言葉は「熱意」。ひときわ目を引く黄色い苞の鮮やかさに由来すると言われる</li>
      <li>花が咲くのは初夏だが、その色の力強さにちなんでこの日の誕生花に選ばれている</li>
      <li>内側の情熱をまっすぐ表したい日に寄り添う花</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/nov/1117/';
  $prevTitle = '11月17日の誕生花（ネリネ）とは';
  $nextUrl   = '/articles/calendar/birthflower/nov/1119/';
  $nextTitle = '11月19日の誕生花（ペリストロフェ）とは';
...
<?php $currentSlug='calendar-birthflower-nov-1118'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-nov-1118');
?>