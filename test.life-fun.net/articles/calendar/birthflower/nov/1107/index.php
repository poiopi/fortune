...
<head>
  ...
  <meta name="description" content="11月7日の誕生花ミニバラ（赤）の花言葉・特徴・魅力をわかりやすく解説。「特別な功績」を象徴する赤い花の意味を紹介します。">
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"ミニバラ（赤）はいつ頃咲きますか？","acceptedAnswer":{"@type":"Answer","text":"小輪の赤い花をたくさん咲かせます。バラ科の落葉低木です。"}},
      {"@type":"Question","name":"ミニバラ（赤）の花言葉の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"小輪ながら赤い花をたくさん咲かせ、存在感を放つ姿が、特別な功績を称える意味を思わせることに由来すると言われています。"}},
      {"@type":"Question","name":"ミニバラ（赤）は通常のバラと何が違いますか？","acceptedAnswer":{"@type":"Answer","text":"花や樹形が小さく、鉢植えなど限られたスペースでも育てやすいのが特徴です。"}}
    ]
  }
  </script>
...
<div class="wrap">
  ...
  <div class="art-hero">
    ...
    <p class="art-lead">ミニバラ（赤）は、バラ科の落葉低木で、小輪の赤い花をたくさん咲かせる、華やかで凛々しい印象を持つ花です。花言葉は「特別な功績」。華やかな花です。</p>
  </div>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">ミニバラ（赤）とは</a></li>
      <li><a href="#meaning">ミニバラ（赤）が象徴する意味</a></li>
      <li><a href="#charm">ミニバラ（赤）の魅力</a></li>
  ...
  <section class="art-section" id="about">
    <h2>ミニバラ（赤）とは</h2>
    <p>ミニバラ（赤）は、バラ科の落葉低木で、11月7日の誕生花として知られています。小輪の赤い花をたくさん咲かせる、華やかで凛々しい印象を持つ花です。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>ミニバラ（赤）が象徴する意味</h2>
    <p>ミニバラ（赤）の花言葉は「特別な功績」です。小輪ながら赤い花をたくさん咲かせ、存在感を放つ姿が、特別な功績を称える意味を思わせることに由来すると言われています。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>ミニバラ（赤）の魅力</h2>
    <p>ミニバラ（赤）の魅力は、小輪ながらたくさんの赤い花が集まって咲く華やかさと、コンパクトながら存在感のある姿にあります。11月7日生まれの方はもちろん、功績を称えたい贈り物にもふさわしい花です。</p>
  </section>

  <section class="art-section" id="care">
    <h2>育て方</h2>
    <p>ミニバラは日当たりと風通しの良い場所を好み、こまめな剪定を行うと管理するとよく育ちます。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が誕生花なら</h2>
    <p>11月7日生まれの方はもちろん、功績を称えたい贈り物としてもミニバラ（赤）は人気の花です。開運カレンダーでは、誕生花だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ミニバラ（赤）はいつ頃咲きますか？</div>
        <div class="faq-a">小輪の赤い花をたくさん咲かせます。バラ科の落葉低木です。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ミニバラ（赤）の花言葉の由来は何ですか？</div>
        <div class="faq-a">小輪ながら赤い花をたくさん咲かせ、存在感を放つ姿が、特別な功績を称える意味を思わせることに由来すると言われています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ミニバラ（赤）は通常のバラと何が違いますか？</div>
        <div class="faq-a">花や樹形が小さく、鉢植えなど限られたスペースでも育てやすいのが特徴です。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>ミニバラ（赤）は小輪の赤い花をたくさん咲かせる、11月7日の誕生花</li>
      <li>花言葉は「特別な功績」、たくさん咲いて存在感を放つ姿に由来する</li>
      <li>コンパクトながら華やかな存在感が魅力</li>
      <li>日当たりと風通しの良い場所を好み、こまめな剪定を行うと管理するとよく育ちます</li>
    </ul>
  </section>
