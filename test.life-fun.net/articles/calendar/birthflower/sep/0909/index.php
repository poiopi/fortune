...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/birthflower/sep/0909/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="9月9日の誕生花ベゴニア（白）の花言葉・特徴・魅力をわかりやすく解説。「親切」を象徴する白い花の意味を紹介します。">
  <title>9月9日の誕生花はベゴニア（白）｜花言葉と魅力をわかりやすく解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月9日の誕生花（ベゴニア（白））とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0909/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月9日の誕生花（ベゴニア（白））とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0908/';
  $prevTitle = '9月8日の誕生花（ヤツシロソウ）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0910/';
  $nextTitle = '9月10日の誕生花（タムラソウ）とは';
...
<?php $currentSlug='calendar-birthflower-sep-0909'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0909');
?>