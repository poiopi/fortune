  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月14日の誕生花（ホトトギス）とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0914/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月14日の誕生花（ホトトギス）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0913/';
  $prevTitle = '9月13日の誕生花（ランタナ）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0915/';
  $nextTitle = '9月15日の誕生花（ヨメナ）とは';
...
<?php $currentSlug='calendar-birthflower-sep-0914'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0914');
?>