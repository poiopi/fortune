  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月28日の誕生花（リンドウ）とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0928/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月28日の誕生花（リンドウ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0927/';
  $prevTitle = '9月27日の誕生花（フウセンカズラ）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0929/';
  $nextTitle = '9月29日の誕生花（アキノノゲシ）とは';
...
<?php $currentSlug='calendar-birthflower-sep-0928'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0928');
?>