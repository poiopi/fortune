  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月11日の誕生花（サルスベリ）とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0911/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月11日の誕生花（サルスベリ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>サルスベリ</dd>
    <dt>花言葉</dt><dd>雄弁</dd>
    <dt>科名</dt><dd>ミソハギ科</dd>
    <dt>見頃</dt><dd>夏〜秋</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0910/';
  $prevTitle = '9月10日の誕生花（タムラソウ）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0912/';
  $nextTitle = '9月12日の誕生花（コスモス）とは';
...
<?php $currentSlug='calendar-birthflower-sep-0911'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0911');
?>