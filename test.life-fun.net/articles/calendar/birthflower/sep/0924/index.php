  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月24日の誕生花（ユウゼンギク）とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0924/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月24日の誕生花（ユウゼンギク）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0923/';
  $prevTitle = '9月23日の誕生花（サガギク）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0925/';
  $nextTitle = '9月25日の誕生花（ノコンギク）とは';
...
<?php $currentSlug='calendar-birthflower-sep-0924'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0924');
?>