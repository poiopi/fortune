  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月5日の誕生花（オミナエシ）とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0905/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月5日の誕生花（オミナエシ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>オミナエシ</dd>
    <dt>花言葉</dt><dd>美人</dd>
    <dt>科名</dt><dd>オミナエシ科</dd>
    <dt>見頃</dt><dd>秋</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0904/';
  $prevTitle = '9月4日の誕生花（バタフライブッシュ）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0906/';
  $nextTitle = '9月6日の誕生花（ツリガネヤナギ）とは';
...
<?php $currentSlug='calendar-birthflower-sep-0905'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0905');
?>