  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月15日の誕生花（ヨメナ）とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0915/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月15日の誕生花（ヨメナ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0914/';
  $prevTitle = '9月14日の誕生花（ホトトギス）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0916/';
  $nextTitle = '9月16日の誕生花（アスクレピアス）とは';
...
<?php $currentSlug='calendar-birthflower-sep-0915'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0915');
?>