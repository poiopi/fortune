  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"4月6日の誕生花（スオウバナ）とは","item":"https://life-fun.net/articles/calendar/birthflower/apr/0406/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/apr/">4月の誕生花とは</a><span>›</span>4月6日の誕生花（スオウバナ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>スオウバナ</dd>
    <dt>花言葉</dt><dd>豊かな生活</dd>
    <dt>科名</dt><dd>マメ科</dd>
    <dt>見頃</dt><dd>春</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/apr/0405/';
  $prevTitle = '4月5日の誕生花（コデマリ）とは';
  $nextUrl   = '/articles/calendar/birthflower/apr/0407/';
  $nextTitle = '4月7日の誕生花（サクラ）とは';
...
<?php $currentSlug='calendar-birthflower-apr-0406'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-apr-0406');
?>
