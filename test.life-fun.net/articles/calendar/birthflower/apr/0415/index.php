  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"4月15日の誕生花（タンポポ）とは","item":"https://life-fun.net/articles/calendar/birthflower/apr/0415/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/apr/">4月の誕生花とは</a><span>›</span>4月15日の誕生花（タンポポ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/apr/0414/';
  $prevTitle = '4月14日の誕生花（ハルジオン）とは';
  $nextUrl   = '/articles/calendar/birthflower/apr/0416/';
  $nextTitle = '4月16日の誕生花（ライラック）とは';
...
<?php $currentSlug='calendar-birthflower-apr-0415'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-apr-0415');
?>
