  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"8月22日の誕生花（ジャノメギク）とは","item":"https://life-fun.net/articles/calendar/birthflower/aug/0822/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/aug/">8月の誕生花とは</a><span>›</span>8月22日の誕生花（ジャノメギク）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ジャノメギク</dd>
    <dt>花言葉</dt><dd>せつない喜び</dd>
    <dt>科名</dt><dd>キク科</dd>
    <dt>見頃</dt><dd>初夏〜秋</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/aug/0821/';
  $prevTitle = '8月21日の誕生花（ヒャクニチソウ）とは';
  $nextUrl   = '/articles/calendar/birthflower/aug/0823/';
  $nextTitle = '8月23日の誕生花（ナツスミレ）とは';
...
<?php $currentSlug='calendar-birthflower-aug-0822'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-aug-0822');
?>