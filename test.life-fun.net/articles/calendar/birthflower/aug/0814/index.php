  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"8月14日の誕生花（サルビア（赤））とは","item":"https://life-fun.net/articles/calendar/birthflower/aug/0814/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/aug/">8月の誕生花とは</a><span>›</span>8月14日の誕生花（サルビア（赤））とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>サルビア（赤）</dd>
    <dt>花言葉</dt><dd>燃ゆる想い</dd>
    <dt>科名</dt><dd>シソ科</dd>
    <dt>見頃</dt><dd>夏〜秋</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/aug/0813/';
  $prevTitle = '8月13日の誕生花（ルドベキア）とは';
  $nextUrl   = '/articles/calendar/birthflower/aug/0815/';
  $nextTitle = '8月15日の誕生花（ミント）とは';
...
<?php $currentSlug='calendar-birthflower-aug-0814'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
