...
<div class="wrap">
  ...
  <section class="art-section" id="months">
    ...
    <div class="type-grid">
      ...
      <a href="/articles/calendar/birthflower/dec/" class="type-card"><div class="type-code">12月</div><div class="type-name">12月の誕生花</div><div class="type-kw">サフラン・ポインセチア・カトレアなど</div></a>
    </div>
  </section>
