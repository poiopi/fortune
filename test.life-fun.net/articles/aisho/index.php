...
<div class="wrap">
  ...
  <div class="cta-box">
    ...
    <a href="/aisho" class="cta-btn">相性診断をする →</a>
  </div>
  ...
  <section class="art-section" id="related">
    ...
    <div class="related-grid">
      ...
      <a href="/articles/mbti/" class="related-card">
        <div class="related-card-label">MBTI診断とは</div>
        <div class="related-card-title">16タイプの性格と4つの指標を解説 →</div>
      </a>
      <a href="/articles/numerology/" class="related-card">
        <div class="related-card-label">数秘術とは</div>
        <div class="related-card-title">運命数で二人の相性を深掘り →</div>
      </a>
      <a href="/articles/tarot/" class="related-card">
        <div class="related-card-label">タロット占いとは</div>
        <div class="related-card-title">二人の関係をタロットで読む →</div>
      </a>
    </div>
  </section>
