...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/love/bundle/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="恋愛タイプ（Bundle）別の恋愛傾向を、Love Engineの実測データ（9216パターン分析）で解説。5つの恋愛タイプがなぜそうなるか、理由つきで紹介。">
  <title>恋愛タイプ（Bundle）×恋愛傾向｜5タイプの恋愛スタイルを実測データで解説</title>
...
<div class="wrap">
  ...
  <div class="art-hero">
    ...
    <h1>恋愛タイプ（Bundle）×恋愛傾向</h1>
    <p class="art-lead">診断結果に表示される恋愛タイプの文章は、5つの性格プリミティブのうち最も強い1つによって決まります。Love Engineが9216パターンを分析した実測データをもとに、5つの恋愛タイプそれぞれの傾向を、なぜそうなるかという理由つきで解説します。</p>
  </div>
  ...
  <section class="art-section">
    ...
    <div class="type-grid">
      ...
      <a href="/articles/love/bundle/<?= htmlspecialchars($t['slug']) ?>/" class="type-card">
...
<?php
$html = ob_get_clean();
echo autoLink($html, 'love-bundle-index');
?>
