...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/love/seiza/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="12星座別の恋愛傾向を、Love Engineの実測データ（9216パターン分析）で解説。恋愛スタイル・結婚観の傾向とその理由を紹介。">
  <title>星座×恋愛傾向｜12星座別の恋愛スタイルを実測データで解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .type-code{font-family:var(--ff-mono);font-size:1.2rem;color:var(--accent)}
...
<div class="wrap">
  ...
  <div class="art-hero">
    ...
    <h1>星座×恋愛傾向</h1>
    <p class="art-lead">Love Engineが9216パターンの診断結果を分析した実測データをもとに、12星座それぞれの恋愛スタイル・結婚観の傾向を、なぜそうなるかという理由つきで解説します。</p>
  </div>
  ...
  <section class="art-section">
    ...
    <div class="type-grid">
      ...
      <a href="/articles/love/seiza/<?= htmlspecialchars($t['slug']) ?>/" class="type-card">
...
<?php
$html = ob_get_clean();
echo autoLink($html, 'love-seiza-index');
?>
