...
<div class="wrap">
  ...
  <div class="article-cta"><div class="article-cta-text">
    ...
    <a href="/guardian" class="article-cta-btn">守護霊を診断する →</a>
  </div>
  ...
  <section class="art-section" id="related">
    ...
    <div class="article-related-grid">
      ...
      <a href="/articles/zense/" class="article-related-item">
        <div class="article-related-label">前世診断とは</div>
        <div class="article-related-title">前世・輪廻転生・カルマの意味を解説 →</div>
      </a>
      ...
      <a href="/articles/tarot/" class="article-related-item">
        ...
        <div class="article-related-title">22枚の大アルカナの意味と読み方 →</div>
      </a>
    </div>
  </section>
