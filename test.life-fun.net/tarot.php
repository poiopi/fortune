...
.tool-desc p:last-child{margin-bottom:0}
  ...
  .tcard-front{
    ...
    box-shadow:0 0 20px rgba(201,168,76,.35),0 0 40px rgba(155,114,239,.2);
    padding:4px 3px;
    justify-content:space-between;
  }
  .tcard-front::before,.tcard-front::after{content:'';position:absolute;width:6px;height:6px;border:1px solid rgba(201,168,76,.65)}
  .tcard-front::before{top:3px;left:3px;border-right:none;border-bottom:none}
  .tcard-front::after{bottom:3px;right:3px;border-left:none;border-top:none}
  .tcard-front-num{font-family:var(--ff-mono);font-size:.42rem;color:rgba(201,168,76,.7);letter-spacing:.05em}
  .tcard-front-img{flex:1;display:flex;align-items:center;justify-content:center;width:100%;padding:2px 0}
  .tcard-front-img img{max-width:80%;max-height:100%;object-fit:contain}
  .tcard-front-name{font-family:var(--ff-serif);font-size:.52rem;font-weight:700;color:var(--gold-lt);text-align:center;line-height:1.2}
  ...
  .big-front{transform:rotateY(180deg);background:linear-gradient(170deg,#1e0e42,#0d051f);border:2px solid var(--gold);box-shadow:0 0 40px rgba(201,168,76,.5),0 0 80px rgba(155,114,239,.25);justify-content:space-between;padding:10px 8px}
  .big-front::before,.big-front::after{content:'';position:absolute;width:10px;height:10px;border:1.5px solid rgba(201,168,76,.7)}
  .big-front::before{top:6px;left:6px;border-right:none;border-bottom:none}
  .big-front::after{bottom:6px;right:6px;border-left:none;border-top:none}
  .big-img{flex:1;display:flex;align-items:center;justify-content:center;width:100%;padding:4px 0}
  .big-img img{max-width:75%;max-height:100%;object-fit:contain}
  .big-num{font-family:var(--ff-mono);font-size:.75rem;color:rgba(201,168,76,.8);letter-spacing:.12em}
...
<?php $currentPage='tarot'; require __DIR__.'/inc/header.php'; ?>
  ...
  <div class="wrap">
    ...
    <div class="tool-desc">
      ...
      <p>このツールでは、あなたが選んだカードから今必要なメッセージやアドバイスを導き出します。現在の悩みへの気づきや、選択を迷ったときのヒントとしてお役立てください。</p>
    </div>
...
<?php require __DIR__.'/inc/footer.php'; ?>
  ...
  // ══ タロットデータ 22枚 ══════════════════════════════════════════
  const TAROT = [
    {num:'0',   order:0,  name:'愚者',      en:'The Fool',           img:'fool',           sym:'&#x1F4AB;', // 💫 自由・旅立ち
    ...
    {num:'I',   order:1,  name:'魔術師',    en:'The Magician',       img:'magician',       sym:'&#x221E;',  // ∞ 無限の力
    ...
    {num:'II',  order:2,  name:'女教皇',    en:'The High Priestess', img:'high-priestess', sym:'&#x263D;',  // ☽ 月・直感
    ...
    {num:'III', order:3,  name:'女帝',      en:'The Empress',        img:'empress',        sym:'&#x273F;',  // ✿ 花・豊穣
    ...
    {num:'IV',  order:4,  name:'皇帝',      en:'The Emperor',        img:'emperor',        sym:'&#x25B2;',  // ▲ 権力・頂点
    ...
    {num:'V',   order:5,  name:'法王',      en:'The Hierophant',     img:'hierophant',     sym:'&#x271E;',  // ✞ 十字・信仰
    ...
    {num:'VI',  order:6,  name:'恋人',      en:'The Lovers',         img:'lovers',         sym:'&#x2665;',  // ♥ 愛・心
    ...
    {num:'VII', order:7,  name:'戦車',      en:'The Chariot',        img:'chariot',        sym:'&#x2605;',  // ★ 勝利の星
    ...
    {num:'VIII',order:8,  name:'力',        en:'Strength',           img:'strength',       sym:'&#x221E;&#xFE0F;', // 無限＋力
    ...
    {num:'IX',  order:9,  name:'隠者',      en:'The Hermit',         img:'hermit',         sym:'&#x2606;',  // ☆ 孤高の光
    ...
    {num:'X',   order:10, name:'運命の輪',  en:'Wheel of Fortune',   img:'wheel',          sym:'&#x2299;',  // ⊙ 輪・サイクル
    ...
    {num:'XI',  order:11, name:'正義',      en:'Justice',            img:'justice',        sym:'&#x2696;',  // ⚖ 天秤・公正
    ...
    {num:'XII', order:12, name:'吊られた男',en:'The Hanged Man',     img:'hanged-man',     sym:'&#x2646;',  // ♆ 海王星・逆転
    ...
    {num:'XIII',order:13, name:'死神',      en:'Death',              img:'death',          sym:'&#x2620;',  // ☠ 変容・再生
    ...
    {num:'XIV', order:14, name:'節制',      en:'Temperance',         img:'temperance',     sym:'&#x2742;',  // ✲ 調和の花
    ...
    {num:'XV',  order:15, name:'悪魔',      en:'The Devil',          img:'devil',          sym:'&#x26D3;',  // ⛓ 鎖・束縛
    ...
    {num:'XVI', order:16, name:'塔',        en:'The Tower',          img:'tower',          sym:'&#x26A1;',  // ⚡ 雷・崩壊
    ...
    {num:'XVII',order:17, name:'星',        en:'The Star',           img:'star',           sym:'&#x2726;',  // ✦ 輝く星・希望
    ...
    {num:'XVIII',order:18,name:'月',        en:'The Moon',           img:'moon',           sym:'&#x263E;',  // ☾ 三日月・幻想
    ...
    {num:'XIX', order:19, name:'太陽',      en:'The Sun',            img:'sun',            sym:'&#x2600;',  // ☀ 太陽・成功
    ...
    {num:'XX',  order:20, name:'審判',      en:'Judgement',          img:'judgement',      sym:'&#x2604;',  // ☄ 彗星・覚醒
    ...
    {num:'XXI', order:21, name:'世界',      en:'The World',          img:'world',          sym:'&#x25CE;',  // ◎ 完成の輪
