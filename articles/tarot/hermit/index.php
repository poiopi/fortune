...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/tarot/hermit/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="タロット「隠者（THE HERMIT）」の意味を徹底解説。正位置・逆位置それぞれの恋愛・仕事・人間関係への影響と、カードが伝えるメッセージをわかりやすく紹介します。">
  <title>隠者（THE HERMIT）タロットの意味｜正位置・逆位置・恋愛・仕事を解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}:root{--ff-serif:'Shippori Mincho',serif;--ff-sans:'Zen Kaku Gothic New',sans-serif;--ff-mono:'DM Mono',monospace;--accent:#7c4dce;--accent-lt:#9b72ef;--gold:#c9a84c;--text:#1a1a2e;--muted:#6b6b8a;--border:#e5e3ee;--bg:#faf7ff;--bg2:#f8f7fc;}
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"隠者は孤独を意味するカード？","acceptedAnswer":{"@type":"Answer","text":"孤独を意味しますが、ネガティブではありません。賢者の意志的な一人の時間として、自己成長の機会を示しています。"}},{"@type":"Question","name":"隠者が恋愛で出たら？","acceptedAnswer":{"@type":"Answer","text":"正位置は自分を知ることが良い関係の土台になる時期です。逆位置は相手との心理的な距離への警告です。"}},{"@type":"Question","name":"隠者と月の違いは？","acceptedAnswer":{"@type":"Answer","text":"隠者は意志的な内省、月は無意識の深みへの迷い込みです。どちらも内面を扱いますが、その方向性が異なります。"}}]}</script>
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"占いPortal","item":"https://life-fun.net/"},{"@type":"ListItem","position":2,"name":"占い解説ガイド","item":"https://life-fun.net/articles/"},{"@type":"ListItem","position":3,"name":"タロット解説","item":"https://life-fun.net/articles/tarot/"},{"@type":"ListItem","position":4,"name":"隠者（THE HERMIT）","item":"https://life-fun.net/articles/tarot/hermit/"}]}</script>
</head>
<body>
...
<div class="wrap">
  <nav class="breadcrumb"><a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/tarot/">タロット解説</a><span>›</span>隠者（THE HERMIT）</nav>
  ...
  <section class="art-section">
    ...
    $ctaText  = '今のあなたには隠者ではなく、別のカードが現れるかもしれません。';
    $ctaUrl   = '/tarot';
    $ctaBtn   = 'タロット占いを始める →';
    require __DIR__.'/../../../inc/article-cta.php';
    ?>
  ...
  <section class="art-section">
    ...
    <?php
    $prevTitle = '力';
    $prevUrl   = '/articles/tarot/strength/';
    $prevLabel = '← 前のカード';
    $nextTitle = '運命の輪';
    $nextUrl   = '/articles/tarot/wheel/';
    $nextLabel = '次のカード →';
    $listTitle = '大アルカナ一覧';
...
<?php $html=ob_get_clean();echo autoLink($html,'hermit'); ?>