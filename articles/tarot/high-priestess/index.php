...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/tarot/high-priestess/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="タロット「女教皇（THE HIGH PRIESTESS）」の意味を徹底解説。正位置・逆位置それぞれの恋愛・仕事・人間関係への影響と、カードが伝えるメッセージをわかりやすく紹介します。">
  <title>女教皇（THE HIGH PRIESTESS）タロットの意味｜正位置・逆位置・恋愛・仕事を解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .art-hero{padding:2rem 0 1.5rem;border-bottom:1px solid var(--border);display:flex;gap:2rem;align-items:flex-start}.art-hero-text{flex:1}
  ...
  .reading-box{border-radius:10px;padding:1.2rem 1.4rem;margin:1rem 0}.reading-box.upright{background:rgba(124,77,206,.06);border:1px solid rgba(124,77,206,.2)}.reading-box.reversed{background:rgba(180,100,80,.05);border:1px solid rgba(180,100,80,.2)}
  .reading-box-label{font-family:var(--ff-mono);font-size:.65rem;letter-spacing:.15em;margin-bottom:.6rem;font-weight:500}.reading-box.upright .reading-box-label{color:var(--accent)}.reading-box.reversed .reading-box-label{color:#a05040}
...
<div class="wrap">
  ...
  <div class="art-hero">
    <div class="art-hero-text">
      ...
      <h1>女教皇（THE HIGH PRIESTESS）<br>タロットの意味・正位置・逆位置</h1>
      <p class="art-lead">大アルカナ2番「女教皇」は、声に出さない知恵のカードです。答えはすでに内側にある。ただ静かに耳を澄ませることを求めています。直感・神秘・潜在意識——月の光のように穏やかで深い叡智を宿すカード。</p>
      <div class="kw-tags"><span class="kw-tag upright">直感</span><span class="kw-tag upright">神秘</span><span class="kw-tag upright">内なる知恵</span><span class="kw-tag upright">潜在意識</span><span class="kw-tag upright">静寂</span> <span class="kw-tag reversed">秘密</span><span class="kw-tag reversed">直感の無視</span><span class="kw-tag reversed">知識の悪用</span></div>
    </div>
  ...
  <nav class="toc"><p class="toc-title">目次</p><ol><li><a href="#overview">女教皇とはどんなカードか</a></li><li><a href="#upright">正位置の意味</a></li><li><a href="#reversed">逆位置の意味</a></li><li><a href="#love">恋愛での意味</a></li><li><a href="#work">仕事・お金での意味</a></li><li><a href="#faq">よくある質問</a></li></ol></nav>
  <section class="art-section" id="overview"><h2>女教皇とはどんなカードか</h2><p>女教皇は書物を膝に抱き、ザクロの幕の前に静かに座っています。彼女は語りません。しかしすべてを知っています。このカードが現れる時、宇宙はあなたに「もっと静かになれ」と告げています。頭で考えることをやめ、感じることに全意識を向ける時です。答えは外ではなく、あなたの内側の深みに沈んでいます。</p></section>
  ...
  <section class="art-section" id="reversed"><h2>逆位置の意味</h2><div class="reading-box reversed"><div class="reading-box-label">REVERSED · 逆位置</div><p>直感を無視して頭だけで考えている状態、または知っていることを意図的に隠している状態を示します。「なんとなく嫌な感じ」を無視してきたなら、それを丁寧に拾い上げてください。隠し事が積み重なると、必ずひずみが生まれます。</p></div></section>
