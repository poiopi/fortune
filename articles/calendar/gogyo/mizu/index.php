...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/gogyo/mizu/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="五行「水（すい）」の意味・性質・ラッキーカラー・相性を解説。知恵と流れのエネルギーを持つ水のエネルギーを日常に取り入れる方法を紹介します。">
  <title>五行「水（すい）」とは？意味とラッキーカラーをわかりやすく解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"水の五行に合う色は何ですか？","acceptedAnswer":{"@type":"Answer","text":"黒・紺・ネイビーが水のエネルギーに対応する色です。知恵や柔軟性を高めたいとき、服やアクセサリーにこれらの色を取り入れるのがおすすめです。"}},
      {"@type":"Question","name":"水の五行の人はどんな性格ですか？","acceptedAnswer":{"@type":"Answer","text":"水の気が強い人は、知的で柔軟性があり、洞察力に優れた性格とされます。適応力が高く冷静な一方、優柔不断になりやすい面もあるといわれます。"}},
      {"@type":"Question","name":"水は何に剋されますか？","acceptedAnswer":{"@type":"Answer","text":"五行の相剋関係では「土は水を剋す」とされます。土の気が強すぎると水のエネルギーがせき止められるという考え方です。逆に水は火を剋す（水は火を消す）関係にあります。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":5,"name":"水とは","item":"https://life-fun.net/articles/calendar/gogyo/mizu/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/gogyo/">陰陽五行とは</a><span>›</span>水とは
  </nav>

  <div class="art-hero">
    <span class="art-label">MIZU · 五行</span>
    <h1>五行「水（すい）」とは？<br>意味とラッキーカラーをわかりやすく解説</h1>
    <p class="art-lead">水（すい）は陰陽五行の一つで、知恵・流れ・柔軟性を象徴するエネルギーです。形を変えながらどこへでも流れていく水のように、適応力と深い洞察力を表します。意味・ラッキーカラー・相性まで詳しく解説します。</p>
  </div>

  <dl class="basic-info">
    <dt>読み方</dt><dd>すい</dd>
    <dt>象徴するエネルギー</dt><dd>知恵・流れ・柔軟性</dd>
    <dt>ラッキーカラー</dt><dd>黒・紺・ネイビー</dd>
    <dt>季節</dt><dd>冬</dd>
  </dl>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">水の意味</a></li>
      <li><a href="#color">水のラッキーカラー</a></li>
      <li><a href="#personality">水の気を持つ人の性格</a></li>
  ...
  <section class="art-section" id="about">
    <h2>水の意味</h2>
    <p>水（すい）は陰陽五行の中で、形を変えながら流れ続ける水の性質を象徴する要素です。知恵・流れ・柔軟性・静けさを表し、五行の循環の中では冬の季節に対応します。物事の奥深くに浸透し、静かに力を蓄えるエネルギーとして知られています。</p>
    <p>相生の関係では、水は木を生み出す存在です（水は木の成長に不可欠）。一方、相剋の関係では、水は火を消し（水剋火）、土によってせき止められる（土剋水）という関係にあります。</p>
  </section>

  <section class="art-section" id="color">
    <h2>水のラッキーカラー</h2>
    <p>水の気に対応する色は黒・紺・ネイビーです。知恵・静寂・深みを象徴する色で、冷静な判断力や洞察力を高めたいときに効果的とされています。紺色の服を選ぶ・黒のアクセサリーを身につける・ネイビーの小物をデスクに置くといった活用法があります。</p>
    <p>物事を深く考えたいとき・冷静さを取り戻したいときは、水のラッキーカラーである黒・紺系の色を意識的に取り入れると良いとされています。</p>
  </section>

  <section class="art-section" id="personality">
    <h2>水の気を持つ人の性格</h2>
    <p>四柱推命や九星気学において「水」の気が強い人は、知的で柔軟性があり、洞察力に優れた性格とされています。適応力が高く、どんな環境でも柔軟に対応できるタイプです。</p>
    <p>一方で、優柔不断になりやすい・慎重すぎて決断が遅れる面もあるといわれます。水の気が強い人は、時には思い切った決断を意識することで、持ち前の柔軟性と知恵をより効果的に活かせるとされています。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">水の五行に合う色は何ですか？</div>
        <div class="faq-a">黒・紺・ネイビーが水のエネルギーに対応する色です。知恵や柔軟性を高めたいとき、服やアクセサリーにこれらの色を取り入れるのがおすすめです。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">水の五行の人はどんな性格ですか？</div>
        <div class="faq-a">水の気が強い人は、知的で柔軟性があり、洞察力に優れた性格とされます。適応力が高く冷静な一方、優柔不断になりやすい面もあるといわれます。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">水は何に剋されますか？</div>
        <div class="faq-a">五行の相剋関係では「土は水を剋す」とされます。土の気が強すぎると水のエネルギーがせき止められるという考え方です。逆に水は火を剋す（水は火を消す）関係にあります。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>水は知恵・流れ・柔軟性を象徴する五行の一つで、冬の季節に対応する。</li>
      <li>ラッキーカラーは黒・紺・ネイビー。冷静な判断力や洞察力を後押ししてくれるとされる。</li>
      <li>水の気が強い人は知的で柔軟性があるが、優柔不断になりやすい面もある。</li>
      <li>相生では木を生み、相剋では火を剋し、土に剋される関係にある。</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/gogyo/kin/';
  $prevTitle = '金';
  $nextUrl   = null;
  $nextTitle = null;
...
<?php $currentSlug='gogyo-mizu'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'gogyo-mizu');
?>
