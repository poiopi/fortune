...
<head>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .category-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:.9rem;margin-top:1rem}
  ...
  .category-card{background:var(--bg2);border:1px solid var(--border);border-radius:10px;padding:1.1rem 1rem;text-decoration:none;color:inherit;display:flex;flex-direction:column;gap:.5rem;transition:border-color .2s}
  .category-card:hover{border-color:var(--accent-lt)}
  .category-icon{font-size:1.4rem;color:var(--gold);line-height:1}
  .category-name{font-family:var(--ff-serif);font-weight:700;font-size:1.05rem;color:var(--text)}
  .category-desc{font-size:.82rem;color:var(--muted);line-height:1.6;flex:1}
  .category-link{font-family:var(--ff-mono);font-size:.72rem;color:var(--accent);margin-top:.2rem}
...
require __DIR__.'/../../inc/article-cta.php';
  ...
  <nav class="toc">
    ...
    <ol>
      ...
      <li><a href="#categories">運勢を読み解くカテゴリー</a></li>
  ...
  <section class="art-section" id="categories">
    ...
    <div class="category-grid">
      <a href="/articles/calendar/rokuyo/" class="category-card">
        <div class="category-icon">☯</div>
        <div class="category-name">六曜</div>
        <div class="category-desc">先勝・友引・大安など、六曜が持つ意味と過ごし方の目安を紹介しています。</div>
        <div class="category-link">詳しく見る →</div>
      </a>
      <a href="/articles/calendar/gogyo/" class="category-card">
        <div class="category-icon">◈</div>
        <div class="category-name">陰陽五行</div>
        <div class="category-desc">木・火・土・金・水の五行が持つ性質と、ラッキーカラーとの関係を紹介しています。</div>
        <div class="category-link">詳しく見る →</div>
      </a>
      <a href="/articles/calendar/kichijitsu/" class="category-card">
        <div class="category-icon">✦</div>
        <div class="category-name">特別な吉日</div>
        <div class="category-desc">一粒万倍日・天赦日など、特別な吉日の意味とおすすめの過ごし方を紹介しています。</div>
        <div class="category-link">詳しく見る →</div>
      </a>
      <a href="/articles/calendar/moon/" class="category-card">
        <div class="category-icon">☾</div>
        <div class="category-name">月齢</div>
