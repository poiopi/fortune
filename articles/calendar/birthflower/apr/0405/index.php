  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"4月5日の誕生花（コデマリ）とは","item":"https://life-fun.net/articles/calendar/birthflower/apr/0405/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/apr/">4月の誕生花とは</a><span>›</span>4月5日の誕生花（コデマリ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/apr/0404/';
  $prevTitle = '4月4日の誕生花（トリテリア）とは';
  $nextUrl   = '/articles/calendar/birthflower/apr/0406/';
  $nextTitle = '4月6日の誕生花（スオウバナ）とは';
...
<?php $currentSlug='calendar-birthflower-apr-0405'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-apr-0405');
?>
