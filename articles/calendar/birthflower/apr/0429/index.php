  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"4月29日の誕生花（ミヤコグサ）とは","item":"https://life-fun.net/articles/calendar/birthflower/apr/0429/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/apr/">4月の誕生花とは</a><span>›</span>4月29日の誕生花（ミヤコグサ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ミヤコグサ</dd>
    <dt>花言葉</dt><dd>きまぐれな心</dd>
    <dt>科名</dt><dd>マメ科</dd>
    <dt>見頃</dt><dd>春から夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/apr/0428/';
  $prevTitle = '4月28日の誕生花（ローズマリー）とは';
  $nextUrl   = '/articles/calendar/birthflower/apr/0430/';
  $nextTitle = '4月30日の誕生花（ムラサキハナナ）とは';
...
<?php $currentSlug='calendar-birthflower-apr-0429'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-apr-0429');
?>
