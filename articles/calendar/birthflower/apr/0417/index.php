  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"4月17日の誕生花（ユスラウメ）とは","item":"https://life-fun.net/articles/calendar/birthflower/apr/0417/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/apr/">4月の誕生花とは</a><span>›</span>4月17日の誕生花（ユスラウメ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ユスラウメ</dd>
    <dt>花言葉</dt><dd>ノスタルジー</dd>
    <dt>科名</dt><dd>バラ科</dd>
    <dt>見頃</dt><dd>春</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/apr/0416/';
  $prevTitle = '4月16日の誕生花（ライラック）とは';
  $nextUrl   = '/articles/calendar/birthflower/apr/0418/';
  $nextTitle = '4月18日の誕生花（ワスレナグサ）とは';
...
<?php $currentSlug='calendar-birthflower-apr-0417'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-apr-0417');
?>
