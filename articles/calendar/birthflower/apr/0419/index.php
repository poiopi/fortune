  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"4月19日の誕生花（カリフォルニアポピー）とは","item":"https://life-fun.net/articles/calendar/birthflower/apr/0419/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/apr/">4月の誕生花とは</a><span>›</span>4月19日の誕生花（カリフォルニアポピー）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/apr/0418/';
  $prevTitle = '4月18日の誕生花（ワスレナグサ）とは';
  $nextUrl   = '/articles/calendar/birthflower/apr/0420/';
  $nextTitle = '4月20日の誕生花（ルピナス）とは';
...
<?php $currentSlug='calendar-birthflower-apr-0419'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-apr-0419');
?>
