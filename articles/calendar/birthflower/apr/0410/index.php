  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"4月10日の誕生花（ベニバナアセビ）とは","item":"https://life-fun.net/articles/calendar/birthflower/apr/0410/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/apr/">4月の誕生花とは</a><span>›</span>4月10日の誕生花（ベニバナアセビ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ベニバナアセビ</dd>
    <dt>花言葉</dt><dd>静かな主張</dd>
    <dt>科名</dt><dd>ツツジ科</dd>
    <dt>見頃</dt><dd>早春</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/apr/0409/';
  $prevTitle = '4月9日の誕生花（ウォールフラワー）とは';
  $nextUrl   = '/articles/calendar/birthflower/apr/0411/';
  $nextTitle = '4月11日の誕生花（クンシラン）とは';
...
<?php $currentSlug='calendar-birthflower-apr-0410'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-apr-0410');
?>
