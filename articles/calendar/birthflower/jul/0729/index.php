  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"7月29日の誕生花（エキザカム）とは","item":"https://life-fun.net/articles/calendar/birthflower/jul/0729/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jul/">7月の誕生花とは</a><span>›</span>7月29日の誕生花（エキザカム）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>エキザカム</dd>
    <dt>花言葉</dt><dd>愛の告白</dd>
    <dt>科名</dt><dd>リンドウ科</dd>
    <dt>見頃</dt><dd>夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jul/0728/';
  $prevTitle = '7月28日の誕生花（グロリオーサ）とは';
  $nextUrl   = '/articles/calendar/birthflower/jul/0730/';
  $nextTitle = '7月30日の誕生花（ホウセンカ）とは';
...
<?php $currentSlug='calendar-birthflower-jul-0729'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jul-0729');
?>