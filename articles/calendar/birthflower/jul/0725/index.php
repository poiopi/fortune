...
<head>
  ...
  <meta name="description" content="7月25日の誕生花スイセンノウの花言葉・特徴・魅力をわかりやすく解説。「ウィット」を象徴する銀白色の葉と鮮やかな花の意味を紹介します。">
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"スイセンノウはいつ頃咲きますか？","acceptedAnswer":{"@type":"Answer","text":"初夏に鮮やかな花を咲かせます。ナデシコ科の多年草です。"}},
      {"@type":"Question","name":"スイセンノウの花言葉の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"銀白色の葉と鮮やかな花色という意外性のある組み合わせが、気の利いたウィットを象徴することに由来すると言われています。"}},
      {"@type":"Question","name":"スイセンノウの葉が白っぽく見えるのはなぜですか？","acceptedAnswer":{"@type":"Answer","text":"葉や茎に生えた細かい綿毛が光を反射するため、銀白色に見えるとされています。"}}
    ]
  }
  </script>
...
<div class="wrap">
  ...
  <div class="art-hero">
    ...
    <p class="art-lead">スイセンノウは、ナデシコ科の多年草で、初夏になると鮮やかな花を咲かせ、銀白色の葉とのコントラストが印象的な花です。花言葉は「ウィット」。銀白色の葉が印象的な花です。</p>
  </div>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">スイセンノウとは</a></li>
      <li><a href="#meaning">スイセンノウが象徴する意味</a></li>
      <li><a href="#charm">スイセンノウの魅力</a></li>
  ...
  <section class="art-section" id="about">
    <h2>スイセンノウとは</h2>
    <p>スイセンノウは、ナデシコ科の多年草で、7月25日の誕生花として知られています。初夏になると鮮やかな花を咲かせ、銀白色の葉とのコントラストが印象的な花です。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>スイセンノウが象徴する意味</h2>
    <p>スイセンノウの花言葉は「ウィット」です。銀白色の葉と鮮やかな花色という意外性のある組み合わせが、気の利いたウィットを象徴することに由来すると言われています。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>スイセンノウの魅力</h2>
    <p>スイセンノウの魅力は、銀白色の綿毛に覆われた葉と、その中に映える鮮やかな花色のコントラストにあります。銀白色の葉が花壇のアクセントとしても重宝される花です。7月25日生まれの方はもちろん、気の利いた想いを伝えたい贈り物にもふさわしい花です。</p>
  </section>

  <section class="art-section" id="care">
    <h2>育て方</h2>
    <p>スイセンノウは日当たりと水はけの良い場所を好み、乾燥に強く管理するとよく育ちます。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が誕生花なら</h2>
    <p>7月25日生まれの方はもちろん、気の利いた想いを伝えたい贈り物としてもスイセンノウは人気の花です。開運カレンダーでは、誕生花だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">スイセンノウはいつ頃咲きますか？</div>
        <div class="faq-a">初夏に鮮やかな花を咲かせます。ナデシコ科の多年草です。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">スイセンノウの花言葉の由来は何ですか？</div>
        <div class="faq-a">銀白色の葉と鮮やかな花色という意外性のある組み合わせが、気の利いたウィットを象徴することに由来すると言われています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">スイセンノウの葉が白っぽく見えるのはなぜですか？</div>
        <div class="faq-a">葉や茎に生えた細かい綿毛が光を反射するため、銀白色に見えるとされています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>スイセンノウは初夏に鮮やかな花を咲かせる、7月25日の誕生花</li>
      <li>花言葉は「ウィット」、意外性のある色の組み合わせに由来する</li>
      <li>銀白色の葉と鮮やかな花色のコントラストが魅力</li>
      <li>日当たりと水はけの良い場所で、乾燥に強い</li>
    </ul>
  </section>
