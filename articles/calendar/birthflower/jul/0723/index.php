  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"7月23日の誕生花（ツリガネソウ）とは","item":"https://life-fun.net/articles/calendar/birthflower/jul/0723/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jul/">7月の誕生花とは</a><span>›</span>7月23日の誕生花（ツリガネソウ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jul/0722/';
  $prevTitle = '7月22日の誕生花（ナツツバキ）とは';
  $nextUrl   = '/articles/calendar/birthflower/jul/0724/';
  $nextTitle = '7月24日の誕生花（オシロイバナ）とは';
...
<?php $currentSlug='calendar-birthflower-jul-0723'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jul-0723');
?>