  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"3月20日の誕生花（アカシア）とは","item":"https://life-fun.net/articles/calendar/birthflower/mar/0320/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/mar/">3月の誕生花とは</a><span>›</span>3月20日の誕生花（アカシア）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/mar/0319/';
  $prevTitle = '3月19日の誕生花（レンゲソウ）とは';
  $nextUrl   = '/articles/calendar/birthflower/mar/0321/';
  $nextTitle = '3月21日の誕生花（チューリップ（赤））とは';
...
<?php $currentSlug='calendar-birthflower-mar-0320'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-mar-0320');
?>
