  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"3月25日の誕生花（カキツバタ）とは","item":"https://life-fun.net/articles/calendar/birthflower/mar/0325/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/mar/">3月の誕生花とは</a><span>›</span>3月25日の誕生花（カキツバタ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>カキツバタ</dd>
    <dt>花言葉</dt><dd>幸せの誓い</dd>
    <dt>科名</dt><dd>アヤメ科</dd>
    <dt>見頃</dt><dd>初夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/mar/0324/';
  $prevTitle = '3月24日の誕生花（カイドウ）とは';
  $nextUrl   = '/articles/calendar/birthflower/mar/0326/';
  $nextTitle = '3月26日の誕生花（プリムラ・オブコニカ）とは';
...
<?php $currentSlug='calendar-birthflower-mar-0325'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-mar-0325');
?>
