  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"2月4日の誕生花（プリムラ・ポリアンサ）とは","item":"https://life-fun.net/articles/calendar/birthflower/feb/0204/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/feb/">2月の誕生花とは</a><span>›</span>2月4日の誕生花（プリムラ・ポリアンサ）とは
  </nav>
  ...
  <section class="art-section" id="experience">
    ...
    <p class="cta-lead">色とりどりの花に元気をもらえた今日は、ラッキーフードもあわせて確認してみませんか。開運カレンダーでは、その日のラッキーフードや吉日も調べられます。</p>
  </section>
...
<?php $currentSlug='calendar-birthflower-feb-0204'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-feb-0204');
?>
