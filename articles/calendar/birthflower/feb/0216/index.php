  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"2月16日の誕生花（フリージア）とは","item":"https://life-fun.net/articles/calendar/birthflower/feb/0216/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/feb/">2月の誕生花とは</a><span>›</span>2月16日の誕生花（フリージア）とは
  </nav>
  ...
  <section class="art-section" id="experience">
    ...
    <p class="cta-lead">素直な気持ちを言葉にできた今日は、出かける前にラッキープレイスを調べてみるのもおすすめです。開運カレンダーでは、その日のラッキープレイスや吉日も確認できます。</p>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/feb/0215/';
  $prevTitle = '2月15日の誕生花（サンシュユ）とは';
  $nextUrl   = '/articles/calendar/birthflower/feb/0217/';
  $nextTitle = '2月17日の誕生花（ネコヤナギ）とは';
...
<?php $currentSlug='calendar-birthflower-feb-0216'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-feb-0216');
?>
