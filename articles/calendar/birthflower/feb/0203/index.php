...
<div class="wrap">
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/feb/0202/';
  $prevTitle = '2月2日の誕生花（シラー）とは';
  $nextUrl   = '/articles/calendar/birthflower/feb/0204/';
  $nextTitle = '2月4日の誕生花（プリムラ・ポリアンサ）とは';
...
<?php $currentSlug='calendar-birthflower-feb-0203'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-feb-0203');
?>
