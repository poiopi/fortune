  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"2月20日の誕生花（コブシ）とは","item":"https://life-fun.net/articles/calendar/birthflower/feb/0220/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/feb/">2月の誕生花とは</a><span>›</span>2月20日の誕生花（コブシ）とは
  </nav>
  ...
  <section class="art-section" id="experience">
    ...
    <p class="cta-lead">疎遠だった相手を思い出せた今日は、ラッキーカラーを一つ選んで身につけてみるのもいいかもしれません。開運カレンダーでは、その日のラッキーカラーやおすすめの行動も紹介しています。</p>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/feb/0219/';
  $prevTitle = '2月19日の誕生花（プリムラ・ジュリアン）とは';
  $nextUrl   = '/articles/calendar/birthflower/feb/0221/';
  $nextTitle = '2月21日の誕生花（ウメ）とは';
...
<?php $currentSlug='calendar-birthflower-feb-0220'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-feb-0220');
?>
