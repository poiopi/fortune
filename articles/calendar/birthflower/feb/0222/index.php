  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"2月22日の誕生花（ビオラ）とは","item":"https://life-fun.net/articles/calendar/birthflower/feb/0222/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/feb/">2月の誕生花とは</a><span>›</span>2月22日の誕生花（ビオラ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/feb/0221/';
  $prevTitle = '2月21日の誕生花（ウメ）とは';
  $nextUrl   = '/articles/calendar/birthflower/feb/0223/';
  $nextTitle = '2月23日の誕生花（ストック）とは';
...
<?php $currentSlug='calendar-birthflower-feb-0222'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-feb-0222');
?>
