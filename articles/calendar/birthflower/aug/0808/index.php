...
<head>
  ...
  <meta name="description" content="8月8日の誕生花ヒマワリの花言葉・特徴・魅力をわかりやすく解説。「栄光」を象徴する太陽に向かう大輪の花の意味を紹介します。">
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"ヒマワリはいつ頃咲きますか？","acceptedAnswer":{"@type":"Answer","text":"夏に太陽の方を向くように大輪の花を咲かせます。キク科の一年草です。"}},
      {"@type":"Question","name":"ヒマワリの花言葉の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"太陽に向かって堂々と咲く大輪の花姿が、輝かしい成功や栄光を象徴することに由来すると言われています。"}},
      {"@type":"Question","name":"ヒマワリは本当に太陽の方を向くのですか？","acceptedAnswer":{"@type":"Answer","text":"つぼみの時期は太陽の動きに合わせて向きを変える性質がありますが、開花後はほぼ一方向を向いたまま咲き続けます。"}}
    ]
  }
  </script>
...
<div class="wrap">
  ...
  <div class="art-hero">
    ...
    <p class="art-lead">ヒマワリは、キク科の一年草で、夏になると太陽の方を向くように大輪の花を咲かせる、明るく力強い印象を放つ花です。花言葉は「栄光」。明るく力強い花です。</p>
  </div>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">ヒマワリとは</a></li>
      <li><a href="#meaning">ヒマワリが象徴する意味</a></li>
      <li><a href="#charm">ヒマワリの魅力</a></li>
  ...
  <section class="art-section" id="about">
    <h2>ヒマワリとは</h2>
    <p>ヒマワリは、キク科の一年草で、8月8日の誕生花として知られています。夏になると太陽の方を向くように大輪の花を咲かせる、明るく力強い印象を放つ花です。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>ヒマワリが象徴する意味</h2>
    <p>ヒマワリの花言葉は「栄光」です。太陽に向かって堂々と咲く大輪の花姿が、輝かしい成功や栄光を象徴することに由来すると言われています。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>ヒマワリの魅力</h2>
    <p>ヒマワリの魅力は、青空に向かって真っ直ぐ伸びる茎と、太陽そのもののような黄金色の大輪にあります。夏を代表する花として、多くの人に元気と明るさを届けています。8月8日生まれの方はもちろん、栄光をたたえる想いを伝えたい贈り物にもふさわしい花です。</p>
  </section>

  <section class="art-section" id="care">
    <h2>育て方</h2>
    <p>ヒマワリは日当たりを好み、乾燥にはやや強いものの、生育期は水切れに注意して管理するとよく育ちます。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が誕生花なら</h2>
    <p>8月8日生まれの方はもちろん、栄光をたたえる想いを伝えたい贈り物としてもヒマワリは人気の花です。開運カレンダーでは、誕生花だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ヒマワリはいつ頃咲きますか？</div>
        <div class="faq-a">夏に太陽の方を向くように大輪の花を咲かせます。キク科の一年草です。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ヒマワリの花言葉の由来は何ですか？</div>
        <div class="faq-a">太陽に向かって堂々と咲く大輪の花姿が、輝かしい成功や栄光を象徴することに由来すると言われています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ヒマワリは本当に太陽の方を向くのですか？</div>
        <div class="faq-a">つぼみの時期は太陽の動きに合わせて向きを変える性質がありますが、開花後はほぼ一方向を向いたまま咲き続けます。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>ヒマワリは夏に大輪の花を咲かせる、8月8日の誕生花</li>
      <li>花言葉は「栄光」、太陽に向かう花姿に由来する</li>
      <li>黄金色の大輪と力強さが魅力</li>
      <li>日当たりを好み、水切れに注意して育てる</li>
    </ul>
  </section>
