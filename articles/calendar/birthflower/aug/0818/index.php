  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"8月18日の誕生花（クレオメ）とは","item":"https://life-fun.net/articles/calendar/birthflower/aug/0818/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/aug/">8月の誕生花とは</a><span>›</span>8月18日の誕生花（クレオメ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>クレオメ</dd>
    <dt>花言葉</dt><dd>うれしい誤算</dd>
    <dt>科名</dt><dd>フウチョウソウ科</dd>
    <dt>見頃</dt><dd>夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/aug/0817/';
  $prevTitle = '8月17日の誕生花（タッセルフラワー）とは';
  $nextUrl   = '/articles/calendar/birthflower/aug/0819/';
  $nextTitle = '8月19日の誕生花（ガーベラ（ピンク））とは';
...
<?php $currentSlug='calendar-birthflower-aug-0818'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-aug-0818');
?>