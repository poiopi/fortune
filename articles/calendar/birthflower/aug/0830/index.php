...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/birthflower/aug/0830/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="8月30日の誕生花オジギソウの花言葉・特徴・魅力をわかりやすく解説。「愛の記憶」を象徴するピンク色の花の意味を紹介します。">
  <title>8月30日の誕生花はオジギソウ｜花言葉と魅力をわかりやすく解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"8月30日の誕生花（オジギソウ）とは","item":"https://life-fun.net/articles/calendar/birthflower/aug/0830/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/aug/">8月の誕生花とは</a><span>›</span>8月30日の誕生花（オジギソウ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>オジギソウ</dd>
    <dt>花言葉</dt><dd>愛の記憶</dd>
    <dt>科名</dt><dd>マメ科</dd>
    <dt>見頃</dt><dd>夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/aug/0829/';
  $prevTitle = '8月29日の誕生花（クルクマ）とは';
  $nextUrl   = '/articles/calendar/birthflower/aug/0831/';
  $nextTitle = '8月31日の誕生花（スパティフィラム）とは';
...
<?php $currentSlug='calendar-birthflower-aug-0830'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-aug-0830');
?>