  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"8月16日の誕生花（パキスタキス・ルテア）とは","item":"https://life-fun.net/articles/calendar/birthflower/aug/0816/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/aug/">8月の誕生花とは</a><span>›</span>8月16日の誕生花（パキスタキス・ルテア）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/aug/0815/';
  $prevTitle = '8月15日の誕生花（ミント）とは';
  $nextUrl   = '/articles/calendar/birthflower/aug/0817/';
  $nextTitle = '8月17日の誕生花（タッセルフラワー）とは';
...
<?php $currentSlug='calendar-birthflower-aug-0816'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-aug-0816');
?>