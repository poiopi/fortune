  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"12月9日の誕生花（カンガルーポー）とは","item":"https://life-fun.net/articles/calendar/birthflower/dec/1209/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/dec/">12月の誕生花とは</a><span>›</span>12月9日の誕生花（カンガルーポー）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>カンガルーポー</dd>
    <dt>花言葉</dt><dd>不思議</dd>
    <dt>科名</dt><dd>ハエモドルム科</dd>
    <dt>見頃</dt><dd>-</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/dec/1208/';
  $prevTitle = '12月8日の誕生花（シャコバサボテン）とは';
  $nextUrl   = '/articles/calendar/birthflower/dec/1210/';
  $nextTitle = '12月10日の誕生花（レナンセナ）とは';
