  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"12月29日の誕生花（ヒイラギモチ）とは","item":"https://life-fun.net/articles/calendar/birthflower/dec/1229/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/dec/">12月の誕生花とは</a><span>›</span>12月29日の誕生花（ヒイラギモチ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ヒイラギモチ</dd>
    <dt>花言葉</dt><dd>清廉</dd>
    <dt>科名</dt><dd>モチノキ科</dd>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/dec/1228/';
  $prevTitle = '12月28日の誕生花（ストロベリーキャンドル）とは';
  $nextUrl   = '/articles/calendar/birthflower/dec/1230/';
  $nextTitle = '12月30日の誕生花（マネッチア）とは';
