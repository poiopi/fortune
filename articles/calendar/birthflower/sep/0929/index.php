  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月29日の誕生花（アキノノゲシ）とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0929/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月29日の誕生花（アキノノゲシ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>アキノノゲシ</dd>
    <dt>花言葉</dt><dd>クールな恋</dd>
    <dt>科名</dt><dd>キク科</dd>
    <dt>見頃</dt><dd>秋</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0928/';
  $prevTitle = '9月28日の誕生花（リンドウ）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0930/';
  $nextTitle = '9月30日の誕生花（コルチカム）とは';
...
<?php $currentSlug='calendar-birthflower-sep-0929'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0929');
?>