  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月3日の誕生花（ケイトウ）とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0903/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月3日の誕生花（ケイトウ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0902/';
  $prevTitle = '9月2日の誕生花（キク）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0904/';
  $nextTitle = '9月4日の誕生花（バタフライブッシュ）とは';
...
<?php $currentSlug='calendar-birthflower-sep-0903'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0903');
?>