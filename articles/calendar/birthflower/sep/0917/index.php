  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"9月17日の誕生花（チューベローズ）とは","item":"https://life-fun.net/articles/calendar/birthflower/sep/0917/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/sep/">9月の誕生花とは</a><span>›</span>9月17日の誕生花（チューベローズ）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>チューベローズ</dd>
    <dt>花言葉</dt><dd>危険な楽しみ</dd>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/sep/0916/';
  $prevTitle = '9月16日の誕生花（アスクレピアス）とは';
  $nextUrl   = '/articles/calendar/birthflower/sep/0918/';
  $nextTitle = '9月18日の誕生花（サルビア（紫））とは';
...
<?php $currentSlug='calendar-birthflower-sep-0917'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-sep-0917');
?>