  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"6月26日の誕生花（レッドクローバー）とは","item":"https://life-fun.net/articles/calendar/birthflower/jun/0626/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jun/">6月の誕生花とは</a><span>›</span>6月26日の誕生花（レッドクローバー）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jun/0625/';
  $prevTitle = '6月25日の誕生花（アガパンサス）とは';
  $nextUrl   = '/articles/calendar/birthflower/jun/0627/';
  $nextTitle = '6月27日の誕生花（サンダーソニア）とは';
...
<?php $currentSlug='calendar-birthflower-jun-0626'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jun-0626');
?>