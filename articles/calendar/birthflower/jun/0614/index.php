...
<head>
  ...
  <meta name="description" content="6月14日の誕生花ブーゲンビリアの花言葉・特徴・魅力をわかりやすく解説。「情熱」を象徴する鮮やかな色の苞の意味を紹介します。">
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"ブーゲンビリアはいつ頃咲きますか？","acceptedAnswer":{"@type":"Answer","text":"夏を中心に鮮やかな色の苞を咲かせます。オシロイバナ科のつる性低木です。"}},
      {"@type":"Question","name":"ブーゲンビリアの花言葉の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"「情熱」という花言葉は、真紅やピンクなど鮮烈な色合いの苞が燃えるような情熱を連想させることに由来すると言われています。"}},
      {"@type":"Question","name":"ブーゲンビリアの色鮮やかな部分は花びらですか？","acceptedAnswer":{"@type":"Answer","text":"鮮やかに色づいて見える部分は苞と呼ばれる葉が変化したもので、中心にある小さな部分が本来の花です。"}}
    ]
  }
  </script>
...
<div class="wrap">
  ...
  <div class="art-hero">
    ...
    <p class="art-lead">ブーゲンビリアは、オシロイバナ科のつる性低木で、夏を中心に鮮やかな色の苞を咲かせる6月14日の誕生花です。花言葉は「情熱」。南国的で情熱的な印象の花です。</p>
  </div>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">ブーゲンビリアとは</a></li>
      <li><a href="#meaning">ブーゲンビリアが象徴する意味</a></li>
      <li><a href="#charm">ブーゲンビリアの魅力</a></li>
  ...
  <section class="art-section" id="about">
    <h2>ブーゲンビリアとは</h2>
    <p>ブーゲンビリアは、オシロイバナ科のつる性低木で、6月14日の誕生花として知られています。夏を中心に鮮やかな色の苞を咲かせ、南国的で情熱的な印象を漂わせる花です。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>ブーゲンビリアが象徴する意味</h2>
    <p>ブーゲンビリアの花言葉は「情熱」です。真紅やピンクなど鮮烈な色合いの苞が、燃えるような情熱の象徴とされることに由来すると言われています。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>ブーゲンビリアの魅力</h2>
    <p>ブーゲンビリアの魅力は、紙のように薄い苞が幾重にも重なって咲く鮮やかな色彩と、つるを伸ばしながら旺盛に咲き広がる生命力にあります。南国のリゾート地を彩る花としても広く親しまれています。6月14日生まれの方はもちろん、情熱的な想いを伝えたい贈り物にもふさわしい花です。</p>
  </section>

  <section class="art-section" id="care">
    <h2>育て方</h2>
    <p>ブーゲンビリアは日当たりを好み、乾燥気味に管理することでより多くの花を咲かせやすくなります。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が誕生花なら</h2>
    <p>6月14日生まれの方はもちろん、情熱的な想いを伝えたい贈り物としてもブーゲンビリアは人気の花です。開運カレンダーでは、誕生花だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ブーゲンビリアはいつ頃咲きますか？</div>
        <div class="faq-a">夏を中心に鮮やかな色の苞を咲かせます。オシロイバナ科のつる性低木です。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ブーゲンビリアの花言葉の由来は何ですか？</div>
        <div class="faq-a">「情熱」という花言葉は、真紅やピンクなど鮮烈な色合いの苞が燃えるような情熱を連想させることに由来すると言われています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ブーゲンビリアの色鮮やかな部分は花びらですか？</div>
        <div class="faq-a">鮮やかに色づいて見える部分は苞と呼ばれる葉が変化したもので、中心にある小さな部分が本来の花です。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>ブーゲンビリアは夏を中心に鮮やかな苞を咲かせる、6月14日の誕生花</li>
      <li>花言葉は「情熱」、鮮烈な色合いの苞に由来する</li>
      <li>南国的で旺盛に咲き広がる生命力が魅力</li>
      <li>日当たりを好み、乾燥気味の管理でよく育つ</li>
    </ul>
  </section>
