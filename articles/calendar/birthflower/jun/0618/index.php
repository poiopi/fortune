  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"6月18日の誕生花（サギソウ）とは","item":"https://life-fun.net/articles/calendar/birthflower/jun/0618/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/jun/">6月の誕生花とは</a><span>›</span>6月18日の誕生花（サギソウ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/jun/0617/';
  $prevTitle = '6月17日の誕生花（ベニバナ）とは';
  $nextUrl   = '/articles/calendar/birthflower/jun/0619/';
  $nextTitle = '6月19日の誕生花（アリウム）とは';
...
<?php $currentSlug='calendar-birthflower-jun-0618'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jun-0618');
?>