  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"5月25日の誕生花（ニゲラ）とは","item":"https://life-fun.net/articles/calendar/birthflower/may/0525/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/may/">5月の誕生花とは</a><span>›</span>5月25日の誕生花（ニゲラ）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/may/0524/';
  $prevTitle = '5月24日の誕生花（スズラン）とは';
  $nextUrl   = '/articles/calendar/birthflower/may/0526/';
  $nextTitle = '5月26日の誕生花（テマリバナ）とは';
...
<?php $currentSlug='calendar-birthflower-may-0525'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-may-0525');
?>