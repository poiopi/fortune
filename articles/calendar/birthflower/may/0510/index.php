  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"5月10日の誕生花（デルフィニウム）とは","item":"https://life-fun.net/articles/calendar/birthflower/may/0510/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/may/">5月の誕生花とは</a><span>›</span>5月10日の誕生花（デルフィニウム）とは
  </nav>

  <div class="art-hero">
    <span class="art-label">MAY 10 · 誕生花</span>
    <h1>5月10日の誕生花はデルフィニウム<br>花言葉と魅力をわかりやすく解説</h1>
    <p class="art-lead">青や紫の花が空に向かって立ち上がる、初夏へ向かう5月。デルフィニウムが穂状に花を咲かせ始める頃です。澄んだ青紫が描く、初夏の空の続き。</p>
  </div>

  <dl class="basic-info">
    <dt>花名</dt><dd>デルフィニウム</dd>
    <dt>花言葉</dt><dd>陽気</dd>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/may/0509/';
  $prevTitle = '5月9日の誕生花（カスミソウ）とは';
  $nextUrl   = '/articles/calendar/birthflower/may/0511/';
  $nextTitle = '5月11日の誕生花（チューリップ（白））とは';
...
<?php $currentSlug='calendar-birthflower-may-0510'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-may-0510');
?>
