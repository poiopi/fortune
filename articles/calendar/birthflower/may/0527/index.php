...
<head>
  ...
  <meta name="description" content="5月27日の誕生花オダマキの花言葉・特徴・魅力をわかりやすく解説。「はずむ心」を象徴するうつむき加減の独特な花の意味を紹介します。">
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"オダマキはいつ頃咲きますか？","acceptedAnswer":{"@type":"Answer","text":"初夏にうつむき加減の独特な形の花を咲かせます。キンポウゲ科の多年草で、繊細で個性的な佇まいが特徴です。"}},
      {"@type":"Question","name":"オダマキの花言葉の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"「はずむ心」という花言葉は、距と呼ばれる独特の突起が軽やかに跳ねるように見える花姿に由来すると言われています。"}},
      {"@type":"Question","name":"オダマキという名前の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"麻糸を巻きつけた「苧環（おだまき）」という道具に花の形が似ていることから、この名前が付けられたと言われています。"}}
    ]
  }
  </script>
...
<div class="wrap">
  ...
  <div class="art-hero">
    ...
    <p class="art-lead">オダマキは、キンポウゲ科の多年草で、初夏にうつむき加減の独特な形の花を咲かせる5月27日の誕生花です。花言葉は「はずむ心」。</p>
  </div>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">オダマキとは</a></li>
      <li><a href="#meaning">オダマキが象徴する意味</a></li>
      <li><a href="#charm">オダマキの魅力</a></li>
  ...
  <section class="art-section" id="about">
    <h2>オダマキとは</h2>
    <p>オダマキは、キンポウゲ科の多年草で、5月27日の誕生花として知られています。初夏になると、うつむき加減に独特な形の花を咲かせ、繊細で個性的な佇まいから山野草愛好家にも親しまれています。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>オダマキが象徴する意味</h2>
    <p>オダマキの花言葉は「はずむ心」です。距（きょ）と呼ばれる独特の突起が軽やかに跳ねるように見える花姿が、はずむような心の弾みを思わせることに由来すると言われています。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>オダマキの魅力</h2>
    <p>オダマキの魅力は、複雑で個性的な花の形と、うつむいて咲く控えめな美しさにあります。品種によって花色や形も多様で、庭に趣ある表情を添えてくれます。5月27日生まれの方はもちろん、心が弾むような喜びを伝える贈り物にもふさわしい花です。</p>
  </section>

  <section class="art-section" id="care">
    <h2>育て方</h2>
    <p>オダマキは半日陰でも育つ丈夫な多年草で、こぼれ種でも自然に増えることがあります。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が誕生花なら</h2>
    <p>5月27日生まれの方はもちろん、心が弾むような喜びを伝える贈り物としてもオダマキは人気の花です。開運カレンダーでは、誕生花だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">オダマキはいつ頃咲きますか？</div>
        <div class="faq-a">初夏にうつむき加減の独特な形の花を咲かせます。キンポウゲ科の多年草で、繊細で個性的な佇まいが特徴です。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">オダマキの花言葉の由来は何ですか？</div>
        <div class="faq-a">「はずむ心」という花言葉は、距と呼ばれる独特の突起が軽やかに跳ねるように見える花姿に由来すると言われています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">オダマキという名前の由来は何ですか？</div>
        <div class="faq-a">麻糸を巻きつけた「苧環（おだまき）」という道具に花の形が似ていることから、この名前が付けられたと言われています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>オダマキは初夏にうつむいて咲く独特な花の、5月27日の誕生花</li>
      <li>花言葉は「はずむ心」、軽やかに跳ねるような花姿に由来する</li>
      <li>個性的な花の形と控えめな美しさが魅力</li>
      <li>半日陰でも育つ丈夫な多年草</li>
    </ul>
  </section>
