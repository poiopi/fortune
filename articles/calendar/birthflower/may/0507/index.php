  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"5月7日の誕生花（ナスタチウム）とは","item":"https://life-fun.net/articles/calendar/birthflower/may/0507/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/may/">5月の誕生花とは</a><span>›</span>5月7日の誕生花（ナスタチウム）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>ナスタチウム</dd>
    <dt>花言葉</dt><dd>勝利</dd>
    <dt>科名</dt><dd>ノウゼンハレン科</dd>
    <dt>見頃</dt><dd>夏</dd>
  </dl>
  ...
  <section class="art-section" id="story">
    ...
    <p>ナスタチウムの花が広げる橙色や黄色は、見る人の気持ちをぱっと明るくするような鮮やかさを持っています。派手すぎず、それでいてしっかりと目を引くこの色合いは、元気で力強い印象を与えてくれるのです。花の下に広がる丸い葉も、この植物ならではの特徴。葉の輪郭に沿って水玉が転がる様子を見たことがある人もいるかもしれません。こうした鮮やかな色と個性的な葉の組み合わせから、ナスタチウムには「勝利」という花言葉が贈られているといわれています。勝利には、誰かに競り勝つ場面もあれば、自分自身の迷いに打ち勝つ場面もあります。</p>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <p>鮮やかな橙色を見た瞬間、心はふっと前を向きます。ナスタチウムが映し出すのは、誰かに勝つことより自分の迷いを乗り越える強さです。</p>
    <ul>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/may/0506/';
  $prevTitle = '5月6日の誕生花（ユズ）とは';
  $nextUrl   = '/articles/calendar/birthflower/may/0508/';
  $nextTitle = '5月8日の誕生花（カーネーション（赤））とは';
...
<?php $currentSlug='calendar-birthflower-may-0507'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-may-0507');
?>
