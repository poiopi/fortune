  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"5月8日の誕生花（カーネーション（赤））とは","item":"https://life-fun.net/articles/calendar/birthflower/may/0508/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/may/">5月の誕生花とは</a><span>›</span>5月8日の誕生花（カーネーション（赤））とは
  </nav>

  <div class="art-hero">
    <span class="art-label">MAY 8 · 誕生花</span>
    <h1>5月8日の誕生花はカーネーション（赤）<br>花言葉と魅力をわかりやすく解説</h1>
    <p class="art-lead">春の盛りを過ぎ、初夏へと向かう5月。鮮やかな赤い花びらを幾重にも重ねるカーネーション（赤）が、贈り物として選ばれることも多い季節です。幾重にも重なる深い赤色には、言葉よりも雄弁な想いが宿っています。</p>
  </div>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/may/0507/';
  $prevTitle = '5月7日の誕生花（ナスタチウム）とは';
  $nextUrl   = '/articles/calendar/birthflower/may/0509/';
  $nextTitle = '5月9日の誕生花（カスミソウ）とは';
...
<?php $currentSlug='calendar-birthflower-may-0508'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-may-0508');
?>
