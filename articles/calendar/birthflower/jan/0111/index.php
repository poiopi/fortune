...
<div class="wrap">
  ...
  <section class="art-section" id="experience">
    ...
    <p class="cta-lead">素直な気持ちを見つめ直した今日は、運気の流れもあわせてチェックしてみませんか。開運カレンダーでは、今月の誕生石もわかります。</p>
  </section>
...
<?php $currentSlug='calendar-birthflower-jan-0111'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jan-0111');
?>
