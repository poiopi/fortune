...
<div class="wrap">
  ...
  <section class="art-section" id="experience">
    ...
    <p class="cta-lead">素直な気持ちを言葉にできた今日は、運気の流れもあわせて確認してみませんか。開運カレンダーでは、ラッキーカラーやラッキーナンバーもわかります。</p>
  </section>
...
<?php $currentSlug='calendar-birthflower-jan-0125'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-jan-0125');
?>
