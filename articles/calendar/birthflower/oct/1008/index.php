...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/birthflower/oct/1008/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="10月8日の誕生花トーチリリーの花言葉・特徴・魅力をわかりやすく解説。「恋の痛み」を象徴する松明のような花穂の意味を紹介します。">
  <title>10月8日の誕生花はトーチリリー｜花言葉と魅力をわかりやすく解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"10月8日の誕生花（トーチリリー）とは","item":"https://life-fun.net/articles/calendar/birthflower/oct/1008/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/oct/">10月の誕生花とは</a><span>›</span>10月8日の誕生花（トーチリリー）とは
  </nav>
  ...
  <dl class="basic-info">
    <dt>花名</dt><dd>トーチリリー</dd>
    <dt>花言葉</dt><dd>恋の痛み</dd>
    <dt>科名</dt><dd>ツルボラン科</dd>
    <dt>見頃</dt><dd>夏</dd>
  </dl>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/oct/1007/';
  $prevTitle = '10月7日の誕生花（ハギ）とは';
  $nextUrl   = '/articles/calendar/birthflower/oct/1009/';
  $nextTitle = '10月9日の誕生花（ユーチャリス）とは';
...
<?php $currentSlug='calendar-birthflower-oct-1008'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-oct-1008');
?>