  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":6,"name":"10月9日の誕生花（ユーチャリス）とは","item":"https://life-fun.net/articles/calendar/birthflower/oct/1009/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthflower/">誕生花とは</a><span>›</span><a href="/articles/calendar/birthflower/oct/">10月の誕生花とは</a><span>›</span>10月9日の誕生花（ユーチャリス）とは
  </nav>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthflower/oct/1008/';
  $prevTitle = '10月8日の誕生花（トーチリリー）とは';
  $nextUrl   = '/articles/calendar/birthflower/oct/1010/';
  $nextTitle = '10月10日の誕生花（シオン）とは';
...
<?php $currentSlug='calendar-birthflower-oct-1009'; $pageType='article'; require __DIR__.'/../../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthflower-oct-1009');
?>