...
<head>
  ...
  <meta name="description" content="11月18日の誕生花カラー（黄）の花言葉・特徴・魅力をわかりやすく解説。「熱意」を象徴する黄色い花の意味を紹介します。">
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"カラー（黄）はいつ頃咲きますか？","acceptedAnswer":{"@type":"Answer","text":"初夏に黄色い苞に包まれた花を咲かせます。サトイモ科の多年草です。"}},
      {"@type":"Question","name":"カラー（黄）の花言葉の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"初夏に黄色い苞を明るく咲かせる姿が、内に秘めた熱意を象徴することに由来すると言われています。"}},
      {"@type":"Question","name":"カラーにはどんな色の種類がありますか？","acceptedAnswer":{"@type":"Answer","text":"黄色のほか、白やピンク、紫などさまざまな色の品種があり、それぞれ花言葉が異なります。"}}
    ]
  }
  </script>
...
<div class="wrap">
  ...
  <div class="art-hero">
    ...
    <p class="art-lead">カラー（黄）は、サトイモ科の多年草で、初夏に黄色い苞に包まれた花を咲かせる、明るい印象を持つ花です。花言葉は「熱意」。明るい花です。</p>
  </div>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">カラー（黄）とは</a></li>
      <li><a href="#meaning">カラー（黄）が象徴する意味</a></li>
      <li><a href="#charm">カラー（黄）の魅力</a></li>
  ...
  <section class="art-section" id="about">
    <h2>カラー（黄）とは</h2>
    <p>カラー（黄）は、サトイモ科の多年草で、11月18日の誕生花として知られています。初夏に黄色い苞に包まれた花を咲かせる、明るい印象を持つ花です。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>カラー（黄）が象徴する意味</h2>
    <p>カラー（黄）の花言葉は「熱意」です。初夏に黄色い苞を明るく咲かせる姿が、内に秘めた熱意を象徴することに由来すると言われています。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>カラー（黄）の魅力</h2>
    <p>カラー（黄）の魅力は、らっぱ状に広がる黄色い苞の明るさと、洗練されたフォルムが生む存在感にあります。11月18日生まれの方はもちろん、熱意を伝えたい贈り物にもふさわしい花です。</p>
  </section>

  <section class="art-section" id="care">
    <h2>育て方</h2>
    <p>カラーは日当たりから半日陰を好み、水を好むため土を乾かさないように管理するとよく育ちます。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が誕生花なら</h2>
    <p>11月18日生まれの方はもちろん、熱意を伝えたい贈り物としてもカラー（黄）は人気の花です。開運カレンダーでは、誕生花だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">カラー（黄）はいつ頃咲きますか？</div>
        <div class="faq-a">初夏に黄色い苞に包まれた花を咲かせます。サトイモ科の多年草です。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">カラー（黄）の花言葉の由来は何ですか？</div>
        <div class="faq-a">初夏に黄色い苞を明るく咲かせる姿が、内に秘めた熱意を象徴することに由来すると言われています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">カラーにはどんな色の種類がありますか？</div>
        <div class="faq-a">黄色のほか、白やピンク、紫などさまざまな色の品種があり、それぞれ花言葉が異なります。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>カラー（黄）は初夏に黄色い苞に包まれた花を咲かせる、11月18日の誕生花</li>
      <li>花言葉は「熱意」、明るく咲く黄色い苞の姿に由来する</li>
      <li>らっぱ状に広がる黄色い苞の明るさが魅力</li>
      <li>日当たりから半日陰を好み、水を好むため土を乾かさないように管理するとよく育ちます</li>
    </ul>
  </section>
