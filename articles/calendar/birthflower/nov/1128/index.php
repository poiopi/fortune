...
<head>
  ...
  <meta name="description" content="11月28日の誕生花クリの花言葉・特徴・魅力をわかりやすく解説。「約束」を象徴する実り豊かな花穂の意味を紹介します。">
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"クリはいつ頃咲きますか？","acceptedAnswer":{"@type":"Answer","text":"初夏に独特の香りのする花穂を咲かせ、秋に実を結びます。ブナ科の落葉高木です。"}},
      {"@type":"Question","name":"クリの花言葉の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"初夏に香り立つ花を咲かせ、秋には実りを結ぶ確かな生育のサイクルが、約束を象徴することに由来すると言われています。"}},
      {"@type":"Question","name":"クリはどんな行事と関わりがありますか？","acceptedAnswer":{"@type":"Answer","text":"秋の実りを代表する食材として、栗ご飯や和菓子など季節の食文化に古くから親しまれています。"}}
    ]
  }
  </script>
...
<div class="wrap">
  ...
  <div class="art-hero">
    ...
    <p class="art-lead">クリは、ブナ科の落葉高木で、初夏に独特の香りのする花穂を咲かせ、秋に実を結ぶ、実り豊かで誠実な印象を持つ花です。花言葉は「約束」。誠実な花です。</p>
  </div>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">クリとは</a></li>
      <li><a href="#meaning">クリが象徴する意味</a></li>
      <li><a href="#charm">クリの魅力</a></li>
  ...
  <section class="art-section" id="about">
    <h2>クリとは</h2>
    <p>クリは、ブナ科の落葉高木で、11月28日の誕生花として知られています。初夏に独特の香りのする花穂を咲かせ、秋に実を結ぶ、実り豊かで誠実な印象を持つ植物です。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>クリが象徴する意味</h2>
    <p>クリの花言葉は「約束」です。初夏に香り立つ花を咲かせ、秋には実りを結ぶ確かな生育のサイクルが、約束を象徴することに由来すると言われています。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>クリの魅力</h2>
    <p>クリの魅力は、初夏に咲く独特な香りの花穂と、秋に実る豊かな実がもたらす季節の巡りの確かさにあります。11月28日生まれの方はもちろん、確かな約束を伝えたい贈り物にもふさわしい植物です。</p>
  </section>

  <section class="art-section" id="care">
    <h2>育て方</h2>
    <p>クリは日当たりの良い場所を好み、広い場所で管理するとよく育ちます。</p>
  </section>

  <section class="art-section" id="today">
    <h2>今日が誕生花なら</h2>
    <p>11月28日生まれの方はもちろん、確かな約束を伝えたい贈り物としてもクリは人気です。開運カレンダーでは、誕生花だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">クリはいつ頃咲きますか？</div>
        <div class="faq-a">初夏に独特の香りのする花穂を咲かせ、秋に実を結びます。ブナ科の落葉高木です。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">クリの花言葉の由来は何ですか？</div>
        <div class="faq-a">初夏に香り立つ花を咲かせ、秋には実りを結ぶ確かな生育のサイクルが、約束を象徴することに由来すると言われています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">クリはどんな行事と関わりがありますか？</div>
        <div class="faq-a">秋の実りを代表する食材として、栗ご飯や和菓子など季節の食文化に古くから親しまれています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>クリは初夏に花穂、秋に実をつける、11月28日の誕生花</li>
      <li>花言葉は「約束」、確かな生育のサイクルに由来する</li>
      <li>花から実へと巡る季節の確かさが魅力</li>
      <li>日当たりの良い場所を好み、広い場所で管理するとよく育ちます</li>
    </ul>
  </section>
