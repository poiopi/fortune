...
<head>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"ペリドットはどうやってできるのですか？","acceptedAnswer":{"@type":"Answer","text":"マグマの中で結晶化する数少ない宝石で、火山活動によって地表にもたらされることが多いとされています。"}},
      {"@type":"Question","name":"ペリドットの石言葉の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"「夫婦の幸福」という石言葉は、太陽のような明るい輝きが幸福や安らぎを象徴すると考えられてきたことに由来するとされています。"}},
      {"@type":"Question","name":"ペリドット以外に8月の誕生石はありますか？","acceptedAnswer":{"@type":"Answer","text":"地域や機関によって多少の違いがありますが、日本の誕生石ではペリドットが8月の石として広く知られています。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":5,"name":"8月の誕生石（ペリドット）とは","item":"https://life-fun.net/articles/calendar/birthstone/august/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthstone/">誕生石とは</a><span>›</span>8月の誕生石（ペリドット）とは
  </nav>

  <div class="art-hero">
    <span class="art-label">AUGUST · 誕生石</span>
    <h1>8月の誕生石はペリドット<br>石言葉と魅力をわかりやすく解説</h1>
    <p class="art-lead">ペリドットは、明るいオリーブグリーンが特徴の8月の誕生石です。石言葉は「夫婦の幸福」。太陽の光を思わせる輝きから「太陽の石」とも呼ばれてきました。</p>
  </div>

  <dl class="basic-info">
    <dt>石名</dt><dd>ペリドット</dd>
    <dt>英語名</dt><dd>Peridot</dd>
    <dt>石言葉</dt><dd>夫婦の幸福</dd>
    <dt>色</dt><dd>明るいオリーブグリーン</dd>
  </dl>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">ペリドットとは</a></li>
      <li><a href="#meaning">ペリドットが象徴する意味</a></li>
      <li><a href="#charm">ペリドットの魅力・こんな人におすすめ</a></li>
      <li><a href="#care">お手入れについて</a></li>
      <li><a href="#today">8月が誕生月の人へ</a></li>
  ...
  <section class="art-section" id="about">
    <h2>ペリドットとは</h2>
    <p>ペリドットは、明るいオリーブグリーンが特徴の宝石で、8月の誕生石として知られています。マグマの中で生まれる数少ない宝石の一つで、太陽の光を思わせる黄緑色の輝きが特徴です。古代エジプトでは「太陽の石」と呼ばれ、夜でも輝きを失わない石として珍重されてきました。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>ペリドットが象徴する意味</h2>
    <p>ペリドットの石言葉は「夫婦の幸福」です。太陽のような明るい輝きから、幸福や安らぎをもたらす石とされ、夫婦円満や家庭の幸せを願うお守りとして親しまれてきました。ネガティブな感情を払い、前向きな気持ちをもたらす石ともいわれています。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>ペリドットの魅力・こんな人におすすめ</h2>
    <p>ペリドットの魅力は、太陽の光を閉じ込めたような明るく爽やかな黄緑色にあります。見ているだけで元気をもらえるような色合いは、日常に前向きなエネルギーを添えてくれます。夫婦や家族の幸せを願うとき、明るい気持ちで過ごしたいときのお守りとして選ばれています。8月生まれの方はもちろん、家族への贈り物としても人気です。</p>
  </section>

  <section class="art-section" id="care">
    <h2>お手入れについて</h2>
    <p>ペリドットは急激な温度変化や強い衝撃にやや弱いため、柔らかい布で優しく扱い、他の宝石と分けて保管するのがおすすめです。</p>
  </section>

  <section class="art-section" id="today">
    <h2>8月が誕生月の人へ</h2>
    <p>8月生まれの方はもちろん、家族の幸福を願う贈り物としてもペリドットは人気の石です。開運カレンダーでは、誕生石だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ペリドットはどうやってできるのですか？</div>
        <div class="faq-a">マグマの中で結晶化する数少ない宝石で、火山活動によって地表にもたらされることが多いとされています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ペリドットの石言葉の由来は何ですか？</div>
        <div class="faq-a">「夫婦の幸福」という石言葉は、太陽のような明るい輝きが幸福や安らぎを象徴すると考えられてきたことに由来するとされています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ペリドット以外に8月の誕生石はありますか？</div>
        <div class="faq-a">地域や機関によって多少の違いがありますが、日本の誕生石ではペリドットが8月の石として広く知られています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>ペリドットは明るいオリーブグリーンが特徴的な、8月の誕生石</li>
      <li>石言葉は「夫婦の幸福」、幸福と安らぎを象徴する石とされる</li>
      <li>太陽を思わせる色合いが魅力で、家族への贈り物にも人気</li>
      <li>温度変化や衝撃にやや弱いため、優しい取り扱いが大切</li>
    </ul>
  </section>
  ...
  <?php
  $prevUrl   = '/articles/calendar/birthstone/july/';
  $prevTitle = '7月の誕生石（ルビー）とは';
  $nextUrl   = '/articles/calendar/birthstone/september/';
  $nextTitle = '9月の誕生石（サファイア）とは';
...
<?php $currentSlug='calendar-birthstone-august'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthstone-august');
?>
