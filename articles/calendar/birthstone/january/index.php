...
<head>
  ...
  <meta charset="UTF-8">
  <link rel="canonical" href="https://life-fun.net/articles/calendar/birthstone/january/" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="1月の誕生石ガーネットの石言葉・特徴・魅力をわかりやすく解説。「真実の愛」を象徴する宝石の意味とおすすめの身につけ方を紹介します。">
  <title>1月の誕生石はガーネット｜石言葉と魅力をわかりやすく解説</title>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"ガーネットにはどんな色がありますか？","acceptedAnswer":{"@type":"Answer","text":"誕生石として広く知られているのは深い赤色（ワインレッド）ですが、実際には緑・オレンジ・黄色など多彩な色のガーネットが存在します。"}},
      {"@type":"Question","name":"ガーネットの石言葉「真実の愛」の由来は何ですか？","acceptedAnswer":{"@type":"Answer","text":"時を経ても色褪せない深い赤色が、変わらぬ愛情や絆を象徴すると考えられてきたことに由来するとされています。"}},
      {"@type":"Question","name":"ガーネット以外に1月の誕生石はありますか？","acceptedAnswer":{"@type":"Answer","text":"地域や機関によって多少の違いがありますが、全国宝石卸商協同組合が定める日本の誕生石では、ガーネットが1月の石とされています。"}}
    ]
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":5,"name":"1月の誕生石（ガーネット）とは","item":"https://life-fun.net/articles/calendar/birthstone/january/"}
    ]
  }
  </script>
</head>
...
<div class="wrap">
  <nav class="breadcrumb">
    <a href="/">占いPortal</a><span>›</span><a href="/articles/">占い解説ガイド</a><span>›</span><a href="/articles/calendar/">開運カレンダーとは</a><span>›</span><a href="/articles/calendar/birthstone/">誕生石とは</a><span>›</span>1月の誕生石（ガーネット）とは
  </nav>

  <div class="art-hero">
    <span class="art-label">JANUARY · 誕生石</span>
    <h1>1月の誕生石はガーネット<br>石言葉と魅力をわかりやすく解説</h1>
    <p class="art-lead">ガーネットは、深みのある赤色が特徴的な1月の誕生石です。石言葉は「真実の愛」。変わらぬ絆や情熱を象徴する石として、古くから世界中で愛されてきました。</p>
  </div>

  <dl class="basic-info">
    <dt>石名</dt><dd>ガーネット</dd>
    <dt>英語名</dt><dd>Garnet</dd>
    <dt>石言葉</dt><dd>真実の愛</dd>
    <dt>色</dt><dd>深い赤色（ワインレッド）</dd>
  </dl>
  ...
  <nav class="toc">
    ...
    <ol>
      <li><a href="#about">ガーネットとは</a></li>
      <li><a href="#meaning">ガーネットが象徴する意味</a></li>
      <li><a href="#charm">ガーネットの魅力・こんな人におすすめ</a></li>
      <li><a href="#care">お手入れについて</a></li>
      <li><a href="#today">1月が誕生月の人へ</a></li>
  ...
  <section class="art-section" id="about">
    <h2>ガーネットとは</h2>
    <p>ガーネットは、深みのある赤色が特徴的な宝石で、1月の誕生石として知られています。名前の由来はラテン語で「種子」を意味する言葉とされ、ザクロの実に似た粒状の結晶や色合いを持つことに由来するという説があります。硬度が高く扱いやすいことから、装身具として古代から世界各地で愛用されてきました。</p>
  </section>

  <section class="art-section" id="meaning">
    <h2>ガーネットが象徴する意味</h2>
    <p>ガーネットの石言葉は「真実の愛」です。深く濃い赤色が、時を経ても色褪せることのない愛情や絆を象徴すると考えられ、大切な人との変わらぬ関係を願う石として親しまれてきました。また、情熱と生命力を強める石ともいわれ、古くは旅の安全を守るお守りとしても身につけられてきました。危機から身を守る石、再会をもたらす石といった言い伝えも各地に残っています。</p>
  </section>

  <section class="art-section" id="charm">
    <h2>ガーネットの魅力・こんな人におすすめ</h2>
    <p>ガーネットの魅力は、なんといってもその深く燃えるような赤色にあります。同じ赤系の宝石でも、ルビーの華やかさとは異なり、ガーネットは落ち着きと重厚感を兼ね備えた色合いが特徴です。大切な人との絆を深めたいとき、新しい人間関係のスタートを後押ししたいとき、また困難な状況で自分を鼓舞したいときなど、「変わらない気持ち」を大切にしたい場面でのお守りとして選ばれています。1月生まれの方はもちろん、パートナーや家族への贈り物としても人気があります。</p>
  </section>

  <section class="art-section" id="care">
    <h2>お手入れについて</h2>
    <p>ガーネットは硬度が高く扱いやすい宝石ですが、強い衝撃や急激な温度変化は避け、使用後は柔らかい布で軽く拭いてから保管すると美しさを保ちやすくなります。</p>
  </section>

  <section class="art-section" id="today">
    <h2>1月が誕生月の人へ</h2>
    <p>1月生まれの方はもちろん、大切な人への贈り物としてもガーネットは人気の石です。開運カレンダーでは、誕生石だけでなく六曜や月齢など、日々の運気もあわせて確認できます。</p>
  </section>
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ガーネットにはどんな色がありますか？</div>
        <div class="faq-a">誕生石として広く知られているのは深い赤色（ワインレッド）ですが、実際には緑・オレンジ・黄色など多彩な色のガーネットが存在します。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ガーネットの石言葉「真実の愛」の由来は何ですか？</div>
        <div class="faq-a">時を経ても色褪せない深い赤色が、変わらぬ愛情や絆を象徴すると考えられてきたことに由来するとされています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">ガーネット以外に1月の誕生石はありますか？</div>
        <div class="faq-a">地域や機関によって多少の違いがありますが、全国宝石卸商協同組合が定める日本の誕生石では、ガーネットが1月の石とされています。</div>
      </div>
    </div>
  </section>
  ...
  <section class="art-section" id="matome">
    <h2>まとめ</h2>
    <ul>
      <li>ガーネットは深い赤色が特徴的な、1月の誕生石</li>
      <li>石言葉は「真実の愛」、変わらぬ絆や情熱を象徴する石とされる</li>
      <li>落ち着きと重厚感を兼ね備えた色合いが魅力で、贈り物としても人気</li>
      <li>硬度は高いが、強い衝撃や急激な温度変化には注意して扱いたい</li>
    </ul>
  </section>
  ...
  $prevUrl   = null;
  $prevTitle = null;
  $nextUrl   = '/articles/calendar/birthstone/february/';
  $nextTitle = '2月の誕生石（アメジスト）とは';
  $listUrl   = '/articles/calendar/birthstone/';
  $listTitle = '誕生石一覧';
...
<?php $currentSlug='calendar-birthstone-january'; $pageType='article'; require __DIR__.'/../../../../inc/footer.php'; ?>
</body>
</html>
<?php
$html = ob_get_clean();
echo autoLink($html, 'birthstone-january');
?>
