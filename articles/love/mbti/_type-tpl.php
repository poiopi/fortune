  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":4,"name":"MBTI×恋愛","item":"https://life-fun.net/articles/love/mbti/"},
      {"@type":"ListItem","position":5,"name":"<?= htmlspecialchars($type['code'].'（'.$type['name'].'）の恋愛傾向') ?>","item":"https://life-fun.net/articles/love/mbti/<?= $type['slug'] ?>/"}
    ]
  }
  </script>
  <!--
