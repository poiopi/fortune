...
$item = [
  ...
  'rarityLevel' => '集中しやすい',
  'rarityRank' => '9位（主軸集中度100%、上位14.1%相当）',
  'rarity_note' => 'ISFP×A型の集中度（100%）を64通りの実測分布に照らすと「集中しやすい」に位置します。集中度の高低と、分類（協調型/拮抗型/転換型）の珍しさは別の軸であり、この組み合わせは64通り中9位（上位14.1%相当）です。',
  'conceptLinks' => [
    [
      'name' => '誠実性型',
