...
$item = [
  'slug' => 'isfp-a',
  'name' => 'ISFP×A型',
  'title' => 'ISFP×A型の恋愛傾向と特徴｜誠実性が強く出る理由をデータで解説',
  'h1' => 'ISFP×A型の恋愛傾向と特徴｜誠実性が強く出る理由をデータで解説',
  'description' => 'ISFP×A型の恋愛傾向を144パターンのデータで解説。積極性・愛情表現・嫉妬深さなど7つの恋愛スタイルの傾向と、ISFPとA型のどちらの性格が強く出るかを紹介します。',
  'lead' => 'ISFPは誠実性が、A型は誠実性が、それぞれ単体では恋愛傾向の主軸になりやすいタイプです。この2つを組み合わせたとき、どちらの影響がより強く出るのかを、当サイトの恋愛傾向診断（Love Engine）の実測データから解説します。',
  'classification' => '協調型',
