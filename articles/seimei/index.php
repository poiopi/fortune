...
<head>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  @media(max-width:600px){.art-footer-inner{grid-template-columns:1fr;gap:1.5rem}.cta-box{flex-direction:column;align-items:flex-start}.gokaku-table{font-size:.8rem}}
.al-link{color:var(--accent);text-decoration:underline;text-decoration-style:dotted;text-underline-offset:3px;transition:color .2s}
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      ...
      {"@type":"Question","name":"旧字体と新字体どちらで数えますか？","acceptedAnswer":{"@type":"Answer","text":"姓名判断では一般的に旧字体（正字）の画数を使います。たとえば「渡辺」の「辺」は新字体では5画ですが、旧字体の「邊」は19画です。当サイトでは旧字体・新字体の両方に対応した画数を使用しています。"}},
  ...
  <section class="art-section" id="faq">
    ...
    <div class="faq-list">
      ...
      <div class="faq-item">
        ...
        <div class="faq-a">カタカナ・ひらがなで名前を書く場合は、字源となる漢字の画数を使う流派と、文字そのものの画数を数える流派があります。当サイトでは漢字の画数を基準に鑑定しています。</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">旧字体と新字体どちらで数えますか？</div>
        <div class="faq-a">姓名判断では一般的に旧字体（正字）の画数を使います。たとえば「渡辺」の「辺」は新字体では5画ですが、旧字体の「邊」は19画です。当サイトでは旧字体・新字体の両方に対応した画数を使用しています。</div>
      </div>
      <div class="faq-item">
