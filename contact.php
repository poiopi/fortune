...
<meta charset="UTF-8">
<link rel="canonical" href="https://life-fun.net/contact.php" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="占いPortalへのお問い合わせはinfo@life-fun.netまでご連絡ください。">
...
.today-band{background:linear-gradient(135deg,rgba(201,168,76,.12),rgba(155,114,239,.08));border:1px solid rgba(201,168,76,.25);border-radius:14px;padding:1.5rem 1.8rem;margin-bottom:2rem;text-align:center}
...
<div class="wrap">
  ...
  <div class="today-band">
    <div class="rokuyo-desc">
      <a href="mailto:info@life-fun.net" style="color:var(--gold-lt);font-family:var(--ff-serif);font-size:1.1rem;text-decoration:none">info@life-fun.net</a><br><br>
      当サイトへのご意見、ご感想、お問い合わせなどがございましたら、<br>
      上記メールアドレスまでお願いいたします。
    </div>
  </div>
