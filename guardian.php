...
.date-input-group select.form-input{background-color:#1e1738;-webkit-appearance:none;appearance:none}
...
.tool-desc{background:linear-gradient(135deg,rgba(201,168,76,.07),rgba(155,114,239,.06));border:1px solid rgba(160,130,220,.2);border-radius:14px;padding:1rem 1.4rem;margin-bottom:1rem}
...
<div class="wrap">
  ...
  <div class="tool-desc">
    <p>守護霊診断は、名前と生年月日から、あなたを見守る霊的な存在を読み解くスピリチュアルな診断です。レアリティ（UR・SSR・SRなど）・属性・守護霊名が自動で算出されます。</p>
    <p>このセルフ診断ツールでは、守護霊からのメッセージや相性のいい守護霊も合わせて表示します。自分の感性や直感を見直すきっかけとして、気軽にお楽しみください。</p>
  </div>
  ...
  <div class="form-card" id="formArea">
    ...
    <button class="submit-btn" onclick="diagnose()" data-ga-event="fortune_submit">✦ 守護霊を召喚する ✦</button>
...
// ─── データ ──────────────────────────────────────────────────
const TRIBES=[
  {r:'龍神（天龍）',e:'🐲',s:'天空を司る最上位の龍神。風と雷を操り、高い場所から守護する。',compat:['鳳凰の守護者','星の使者'],bad:['地の精霊','土着の先祖霊'],k:'ryujin'},
  {r:'龍神（水龍）',e:'🌊',s:'深海と川を司る龍神。流れと変化を読み、魂を清める力を持つ。',compat:['海の守護者','月の女神'],bad:['炎の守護者','太陽の神使'],k:'ryujin'},
  {r:'龍神（金龍）',e:'✨',s:'富と繁栄を司る最強の龍神。財運と成功をもたらす最高位の存在。',compat:['太陽の神使','鳳凰の守護者'],bad:['闇の精霊','月の女神'],k:'ryujin'},
  {r:'白狐の精霊',e:'🦊',s:'稲荷神の使いである白狐。鋭い知恵と変化の力で主を導く。',compat:['月の女神','風の精霊'],bad:['龍神（天龍）','武家の先祖霊'],k:'hakko'},
  {r:'鳳凰の守護者',e:'🔥',s:'炎と再生を司る神鳥。苦難のたびに主を蘇らせる力を持つ。',compat:['龍神（金龍）','太陽の神使'],bad:['水龍','海の守護者'],k:'hoo'},
  {r:'武家の先祖霊',e:'⚔️',s:'戦国や武家の時代を生きた先祖の魂。勇気と忠義の心で守護する。',compat:['土着の先祖霊','地の精霊'],bad:['白狐の精霊','天女'],k:'buke-senzo'},
  {r:'巫女の先祖霊',e:'⛩️',s:'神に仕えた巫女の霊。清浄な気を持ち、邪気を祓う守護霊。',compat:['月の女神','天女'],bad:['龍神（天龍）','炎の守護者'],k:'miko-senzo'},
  {r:'陰陽師の先祖霊',e:'☯️',s:'陰陽の理を極めた先祖霊。見えない力を読み解き、バランスを保つ。',compat:['星の使者','風の精霊'],bad:['土着の先祖霊','武家の先祖霊'],k:'onmyoji-senzo'},
  {r:'僧侶の先祖霊',e:'🪷',s:'深い修行を積んだ僧の霊。慈悲の心で主を穏やかに包み込む。',compat:['天女','癒しの精霊'],bad:['炎の守護者','海の守護者'],k:'sou-senzo'},
  {r:'天女・天使',e:'👼',s:'天界から遣わされた光の存在。純粋な愛と癒しのエネルギーで包む。',compat:['巫女の先祖霊','僧侶の先祖霊'],bad:['闇の精霊','白狐の精霊'],k:'tenshi'},
  {r:'大地の精霊',e:'🌿',s:'大地と木々に宿る精霊。根を張り、揺るぎない安定をもたらす。',compat:['土着の先祖霊','武家の先祖霊'],bad:['龍神（天龍）','星の使者'],k:'daichi'},
  {r:'海の守護者',e:'🌊',s:'広大な海を統べる存在。深い包容力と自由な魂を与える守護霊。',compat:['龍神（水龍）','月の女神'],bad:['鳳凰の守護者','炎の守護者'],k:'umi'},
  {r:'星の使者',e:'⭐',s:'宇宙の果てから来た星の精霊。時間と宇宙の理を超えた知恵を持つ。',compat:['陰陽師の先祖霊','風の精霊'],bad:['大地の精霊','土着の先祖霊'],k:'hoshi'},
  {r:'風の精霊',e:'🌬️',s:'風に乗って世界を巡る自由な精霊。変化と旅の力を与える。',compat:['星の使者','白狐の精霊'],bad:['大地の精霊','僧侶の先祖霊'],k:'kaze'},
  {r:'炎の守護者',e:'🔥',s:'業火を制する炎の守護霊。強烈な意志と情熱を魂に灯す。',compat:['鳳凰の守護者','太陽の神使'],bad:['龍神（水龍）','海の守護者'],k:'honoo'},
  {r:'月の女神',e:'🌙',s:'月光を司る女神の霊。直感と感受性を研ぎ澄ませ、深夜に力を増す。',compat:['白狐の精霊','巫女の先祖霊'],bad:['太陽の神使','龍神（金龍）'],k:'tsuki'},
  {r:'太陽の神使',e:'☀️',s:'太陽に仕える神の使い。生命力と行動力を与え、光で道を照らす。',compat:['鳳凰の守護者','龍神（金龍）'],bad:['月の女神','闇の精霊'],k:'taiyou'},
  {r:'森の賢者霊',e:'🌳',s:'古代の森に宿る知恵の霊。長い時間をかけて積んだ叡智を授ける。',compat:['大地の精霊','癒しの精霊'],bad:['炎の守護者','星の使者'],k:'mori-kenja'},
  {r:'癒しの精霊',e:'💚',s:'傷ついた魂を癒す精霊。どんな苦しみも優しく溶かす回復の力を持つ。',compat:['天女','僧侶の先祖霊'],bad:['武家の先祖霊','炎の守護者'],k:'iyashi'},
  {r:'闇の精霊',e:'🌑',s:'影と夜を司る精霊。表には見えない力で主を守り、真実を見通す目を与える。',compat:['月の女神','陰陽師の先祖霊'],bad:['太陽の神使','天女'],k:'yami'},
  {r:'土着の先祖霊',e:'🏺',s:'この土地に長く眠る先祖の霊。生活に根ざした実直な守護をする。',compat:['大地の精霊','武家の先祖霊'],bad:['星の使者','陰陽師の先祖霊'],k:'dochaku-senzo'},
];
...
function diagnose(){
  ...
  runAnimation(rarity,()=>{
    ...
    if (window.rfUpdateArticleLink) rfUpdateArticleLink(tribe.k, '守護霊「'+tribe.r+'」とは？', tribe.s);
